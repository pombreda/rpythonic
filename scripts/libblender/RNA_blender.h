...
PointerRNA AdjustmentSequence_color_balance_get(PointerRNA *ptr);

int AdjustmentSequence_use_float_get(PointerRNA *ptr);

PointerRNA AdjustmentSequence_crop_get(PointerRNA *ptr);

int AdjustmentSequence_use_deinterlace_get(PointerRNA *ptr);

int AdjustmentSequence_use_reverse_frames_get(PointerRNA *ptr);

int AdjustmentSequence_use_flip_x_get(PointerRNA *ptr);

int AdjustmentSequence_use_flip_y_get(PointerRNA *ptr);

float AdjustmentSequence_color_multiply_get(PointerRNA *ptr);

int AdjustmentSequence_use_premultiply_get(PointerRNA *ptr);

PointerRNA AdjustmentSequence_proxy_get(PointerRNA *ptr);

int AdjustmentSequence_use_proxy_custom_directory_get(PointerRNA *ptr);

int AdjustmentSequence_use_proxy_custom_file_get(PointerRNA *ptr);

float AdjustmentSequence_color_saturation_get(PointerRNA *ptr);

float AdjustmentSequence_strobe_get(PointerRNA *ptr);

PointerRNA AdjustmentSequence_transform_get(PointerRNA *ptr);

int AdjustmentSequence_use_color_balance_get(PointerRNA *ptr);

int AdjustmentSequence_use_crop_get(PointerRNA *ptr);

int AdjustmentSequence_use_proxy_get(PointerRNA *ptr);

int AdjustmentSequence_use_translation_get(PointerRNA *ptr);
...
int Armature_vert_deformer_get(PointerRNA *ptr);
...
int BooleanProperty_default_value_get(PointerRNA *ptr);
...
int Brush_use_fixed_texture_get(PointerRNA *ptr);
...
int DomainFluidSettings_surface_noobs_get(PointerRNA *ptr);
...
#define ExplodeModifier_particle_uv_MAX 32
...
PointerRNA GroupInputs_rna_type_get(PointerRNA *ptr);
...
PointerRNA GroupOutputs_rna_type_get(PointerRNA *ptr);
...
int MovieSequence_streamindex_get(PointerRNA *ptr);
...
int RenderSettings_ffmpeg_audio_channels_get(PointerRNA *ptr);
...
int RenderSettings_exr_codec_get(PointerRNA *ptr);
...
int RenderSettings_use_exr_half_get(PointerRNA *ptr);
...
#define RenderSettings_filepath_MAX 240
...
int RenderSettings_exr_preview_get(PointerRNA *ptr);
...
int RenderSettings_ffmpeg_audio_mixrate_get(PointerRNA *ptr);
...
int RenderSettings_exr_zbuf_get(PointerRNA *ptr);
...
int SPHFluidSettings_factor_density_get(PointerRNA *ptr);
...
int SceneGameData_restrict_animation_updates_get(PointerRNA *ptr);
...
int Sequence_waveform_get(PointerRNA *ptr);
...
int Sound_mono_get(PointerRNA *ptr);
...
PointerRNA SpaceImageEditor_curve_get(PointerRNA *ptr);
...
#define UserPreferencesFilePaths_render_output_directory_MAX 240
...
int UserPreferencesInput_ndof_orbit_invert_axes_get(PointerRNA *ptr);
...
int UserPreferencesInput_ndof_zoom_updown_get(PointerRNA *ptr);
