# 36 "/usr/local/include/OGRE/OgreSceneNode.h" 2
...
namespace Ogre {
 ...
 /** Class representing a node in the scene graph.
    ...
    */
    ...
    {
    public:
        typedef ::std::tr1::unordered_map<String, MovableObject*> ObjectMap;
  ...
  bool mShowBoundingBox;
        ...
        void updateFromParentImpl(void) __const__;

        /** See Node. */
        Node* createChildImpl(void);

        /** See Node. */
        Node* createChildImpl(__const__ String& name);
  ...
  bool mIsInSceneGraph;
    public:
        ...
        */
        SceneNode(SceneManager* creator, __const__ String& name);
        ~SceneNode();
        ...
        */
        virtual unsigned short numAttachedObjects(void) __const__;
        ...
        */
        virtual MovableObject* getAttachedObject(__const__ String& name);
        ...
        */
        ...
        virtual MovableObject* detachObject(__const__ String& name);
  ...
  /** Determines whether this node is in the scene graph, i.e.
		...
		*/
  virtual bool isInSceneGraph(void) __const__ { return mIsInSceneGraph; }
  ...
  virtual void _findVisibleObjects(Camera* cam, RenderQueue* queue,
   VisibleObjectsBoundsInfo* visibleBounds,
        ...
        */
        virtual __const__ AxisAlignedBox& _getWorldAABB(void) __const__;
        ...
        */
        ...
        @remarks
            ...
            the object returned through the iterator is OK though.
        */
  virtual ConstObjectIterator getAttachedObjectIterator(void) __const__;
        ...
        */
        SceneManager* getCreator(void) __const__ { return mCreator; }
        ...
        */
        virtual void removeAndDestroyChild(__const__ String& name);
  ...
  virtual void _addBoundingBoxToQueue(RenderQueue* queue);
        ...
        @remarks
			...
			wireframe.
        */
  virtual bool getShowBoundingBox() __const__;
        ...
        */
        virtual SceneNode* createChildSceneNode(
            __const__ Vector3& translate = Vector3::ZERO,
            __const__ Quaternion& rotate = Quaternion::IDENTITY );
        ...
        @remarks
            ...
            @param
                rotate Initial rotation relative to parent
        */
        virtual SceneNode* createChildSceneNode(__const__ String& name, __const__ Vector3& translate = Vector3::ZERO, __const__ Quaternion& rotate = Quaternion::IDENTITY);
        ...
        */
        virtual void findLights(LightList& destList, Real radius, uint32 lightMask = 0xFFFFFFFF) __const__;
        ...
        */
        virtual void setFixedYawAxis( bool useFixed, __const__ Vector3& fixedAxis = Vector3::UNIT_Y );

  /** Rotate the node around the Y-axis.
		*/
  virtual void yaw(__const__ Radian& angle, TransformSpace relativeTo = TS_LOCAL);
        ...
        */
        virtual void setDirection(Real x, Real y, Real z,
            ...
            __const__ Vector3& localDirectionVector = Vector3::NEGATIVE_UNIT_Z);
        ...
        direction of the node, usually -Z
        */
        virtual void setDirection(__const__ Vector3& vec, TransformSpace relativeTo = TS_LOCAL,
            __const__ Vector3& localDirectionVector = Vector3::NEGATIVE_UNIT_Z);
        ...
        direction of the node, usually -Z
        */
        virtual void lookAt( __const__ Vector3& targetPoint, TransformSpace relativeTo,
            __const__ Vector3& localDirectionVector = Vector3::NEGATIVE_UNIT_Z);
        ...
        */
        virtual void setAutoTracking(bool enabled, SceneNode* target = 0,
            __const__ Vector3& localDirectionVector = Vector3::NEGATIVE_UNIT_Z,
            __const__ Vector3& offset = Vector3::ZERO);
  /** Get the auto tracking target for this node, if any. */
        virtual SceneNode* getAutoTrackTarget(void) { return mAutoTrackTarget; }
  /** Get the auto tracking offset for this node, if the node is auto tracking. */
  virtual __const__ Vector3& getAutoTrackOffset(void) { return mAutoTrackOffset; }
  /** Get the auto tracking local direction for this node, if it is auto tracking. */
  virtual __const__ Vector3& getAutoTrackLocalDirection(void) { return mAutoTrackLocalDirection; }
  /** Internal method used by OGRE to update auto-tracking cameras. */
        void _autoTrack(void);
        /** Gets the parent of this SceneNode. */
        SceneNode* getParentSceneNode(void) __const__;
