...
try: h = CppHeaderParser.CppHeader("irr-color-test.h")
...
for name in h.classes:
	...
	if 'template_typename' in k:
		print k['template_typename']
		print k['template_info']
	k.show()

	print '---------------- public methods ----------------'
	for meth in k['methods']['public']:
		print '	method name:', meth['name'], 'constructor:', meth['constructor']
