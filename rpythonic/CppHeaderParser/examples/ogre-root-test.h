...
# 42 "/usr/local/include/OGRE/OgreRoot.h" 2
...
namespace Ogre
{
 ...
 protected:
  ...
  WorkQueue* mWorkQueue;
        ...
        */
        void loadPlugins( __const__ String& pluginsfile = "plugins.cfg" );
  ...
  void populateFrameEvent(FrameEventTimeType type, FrameEvent& evtToUpdate);
    ...
    public:
		...
		*/
        Root(__const__ String& pluginFileName = "plugins.cfg",
   __const__ String& configFileName = "ogre.cfg",
   __const__ String& logFileName = "Ogre.log");
        ~Root();
        ...
        */
        __const__ RenderSystemList& getAvailableRenderers(void);
        ...
        */
        RenderSystem* getRenderSystemByName(__const__ String& name);
        ...
        */
     RenderWindow* initialise(bool autoCreateWindow, __const__ String& windowTitle = "OGRE Render Window",
                                    __const__ String& customCapabilitiesConfig = StringUtil::BLANK);

  /** Returns whether the system is initialised or not. */
  bool isInitialised(void) __const__ { return mIsInitialised; }
  ...
  /** Get whether the entire render queue structure should be emptied on clearing, 
		...
		*/
  bool getRemoveRenderQueueStructuresOnClear() __const__ { return mRemoveQueueStructuresOnClear; }
  ...
  /** Get more information about a given type of SceneManager.
		...
		*/
  __const__ SceneManagerMetaData* getSceneManagerMetaData(__const__ String& typeName) __const__;

  /** Iterate over all types of SceneManager available for construction, 
			providing some information about each one.
		*/
  SceneManagerEnumerator::MetaDataIterator getSceneManagerMetaDataIterator(void) __const__;
  ...
  /** Create a SceneManager instance of a given type.
		...
		*/
  SceneManager* createSceneManager(__const__ String& typeName,
   __const__ String& instanceName = StringUtil::BLANK);
  ...
  /** Get an existing SceneManager instance that has already been created,
		...
		*/
  SceneManager* getSceneManager(__const__ String& instanceName) __const__;

  /** Determines if a given SceneManager already exists
		@param instanceName The name of the instance to retrieve.
		*/
  bool hasSceneManager(__const__ String& instanceName) __const__;
        ...
        */
        ...
        /** Adds a location to the list of searchable locations for a
            ...
            @see
                Archive
        */
        void addResourceLocation(__const__ String& name, __const__ String& locType,
   __const__ String& groupName = ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME,
  ...
  /** Removes a resource location from the list.
		...
		@param groupName The name of the resource group to which this location 
			was assigned.
		*/
  void removeResourceLocation(__const__ String& name,
   __const__ String& groupName = ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME);
  ...
  /** Helper method to assist you in creating writeable file streams.
		...
		*/
  DataStreamPtr createFileStream(__const__ String& filename, __const__ String& groupName = ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME,
   bool overwrite = false, __const__ String& locationPattern = StringUtil::BLANK);
  ...
  /** Helper method to assist you in accessing readable file streams.
		...
		@param locationPattern If the resource group contains multiple locations, 
			...
			will be considered candidates for creation.
		*/
  DataStreamPtr openFileStream(__const__ String& filename, __const__ String& groupName = ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME,
   __const__ String& locationPattern = StringUtil::BLANK);
        ...
        */
        void convertColourValue(__const__ ColourValue& colour, uint32* pDest);
        ...
        */
  RenderWindow* createRenderWindow(__const__ String &name, unsigned int width, unsigned int height,
   bool fullScreen, __const__ NameValuePairList *miscParams = 0) ;

  /** @copydoc RenderSystem::_createRenderWindows
		*/
  bool createRenderWindows(__const__ RenderWindowDescriptionList& renderWindowDescriptions,
   RenderWindowList& createdWindows);
        ...
        */
        void detachRenderTarget( __const__ String & name );
        ...
        */
        void destroyRenderTarget(__const__ String &name);

        /** Retrieves a pointer to the a named render window.
        */
        RenderTarget * getRenderTarget(__const__ String &name);
  ...
  /** Manually load a Plugin contained in a DLL / DSO.
		...
		*/
  void loadPlugin(__const__ String& pluginName);
  ...
  /** Manually unloads a Plugin contained in a DLL / DSO.
		...
		*/
  void unloadPlugin(__const__ String& pluginName);
  ...
  __const__ PluginInstanceList& getInstalledPlugins() __const__ { return mPlugins; }
        ...
        */
		...
		@remarks
			...
			next frame. */
        unsigned long getNextFrameNumber(void) __const__ { return mNextFrame; }
        ...
        */
        SceneManager* _getCurrentSceneManager(void) __const__;
  ...
  Real getFrameSmoothingPeriod(void) __const__ { return mFrameSmoothingTime; }
  ...
  bool hasMovableObjectFactory(__const__ String& typeName) __const__;
  /// Get a MovableObjectFactory for the given type
  MovableObjectFactory* getMovableObjectFactory(__const__ String& typeName);
  ...
  /** Return an iterator over all the MovableObjectFactory instances currently
			registered.
		*/
  MovableObjectFactoryIterator getMovableObjectFactoryIterator(void) __const__;

  /**
		* Gets the number of display monitors.
		*/
  unsigned int getDisplayMonitorCount() __const__;
  ...
  /** Get the WorkQueue for processing background tasks.
		...
		*/
  WorkQueue* getWorkQueue() __const__ { return mWorkQueue; }
  ...
  void setWorkQueue(WorkQueue* queue);
	...
	time_t some_method_returns_time();
