...
def _rpythonic_clean_up_missing_functions_():
	...
	print( RPYTHONIC_WRAPPER_FUNCTIONS_FAILURES )
...
__freeze_rpythonic_struct( __wait_terminated, [
	...
	#opaque-warning# <rpythonic.rpythonic.SomeThing object at 0xc562ecc>
])

__freeze_rpythonic_struct( __wait_stopped, [
	( "__w_stopval", ctypes.c_uint ),
	( "__w_stopsig", ctypes.c_uint ),
	#opaque-warning# <rpythonic.rpythonic.SomeThing object at 0xc5625ac>
])
...
__freeze_rpythonic_struct( __pthread_mutex_s, [
	...
	#opaque-warning# <rpythonic.rpythonic.SomeThing object at 0xc555e2c>
])
