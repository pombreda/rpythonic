...
class CvInput(ctypes.Union): pass
class CvImgObsInfo(_rpythonic_struct_): pass
class CvEHMMState(_rpythonic_struct_): pass
class CvEHMM(_rpythonic_struct_): pass
class u(ctypes.Union): pass
class CvGraphWeightedVtx(_rpythonic_struct_): pass
class CvGraphWeightedEdge(_rpythonic_struct_): _array_wrapper_ = True
class CvCliqueFinder(_rpythonic_struct_): pass
class CvStereoLineCoeff(_rpythonic_struct_): pass
class CvCamera(_rpythonic_struct_): _array_wrapper_ = True
class CvStereoCamera(_rpythonic_struct_): _array_wrapper_ = True
class CvContourOrientation(_rpythonic_struct_): _array_wrapper_ = True
class CvGLCM(_rpythonic_struct_): pass
class CvFaceTracker(_rpythonic_struct_): pass
class CvFace(_rpythonic_struct_): pass
class Cv3dTracker2dTrackedObject(_rpythonic_struct_): pass
class Cv3dTrackerTrackedObject(_rpythonic_struct_): pass
class Cv3dTrackerCameraInfo(_rpythonic_struct_): _array_wrapper_ = True
class Cv3dTrackerCameraIntrinsics(_rpythonic_struct_): _array_wrapper_ = True
class CvVoronoiSite2D(_rpythonic_struct_): _array_wrapper_ = True
class CvVoronoiEdge2D(_rpythonic_struct_): _array_wrapper_ = True
class CvVoronoiNode2D(_rpythonic_struct_): pass
class CvVoronoiDiagram2D(_rpythonic_struct_): pass
class CvLCMEdge(_rpythonic_struct_): _array_wrapper_ = True
class CvLCMNode(_rpythonic_struct_): pass
class CvBGStatModel(_rpythonic_struct_): pass
class CvFGDStatModelParams(_rpythonic_struct_): pass
class CvBGPixelCStatTable(_rpythonic_struct_): _array_wrapper_ = True
class CvBGPixelCCStatTable(_rpythonic_struct_): _array_wrapper_ = True
class CvBGPixelStat(_rpythonic_struct_): pass
class CvFGDStatModel(_rpythonic_struct_): pass
class CvGaussBGStatModelParams(_rpythonic_struct_): pass
class CvGaussBGValues(_rpythonic_struct_): _array_wrapper_ = True
class CvGaussBGPoint(_rpythonic_struct_): pass
class CvGaussBGModel(_rpythonic_struct_): pass
class CvBGCodeBookElem(_rpythonic_struct_): _array_wrapper_ = True
class CvBGCodeBookModel(_rpythonic_struct_): _array_wrapper_ = True
class CvConDensation(_rpythonic_struct_): pass
...
__freeze_rpythonic_struct( CvInput, [
	( "callback", ctypes.CFUNCTYPE(ctypes.c_int, ctypes.c_int,ctypes.POINTER(ctypes.c_void_p),ctypes.POINTER(ctypes.c_void_p),) ),
	( "data", ctypes.POINTER(ctypes.c_void_p) ),
])

__freeze_rpythonic_struct( CvImgObsInfo, [
	( "obs_x", ctypes.c_int ),
	( "obs_y", ctypes.c_int ),
	( "obs_size", ctypes.c_int ),
	( "obs", ctypes.POINTER(ctypes.c_float) ),
	( "state", ctypes.POINTER(ctypes.c_int) ),
	( "mix", ctypes.POINTER(ctypes.c_int) ),
])

__freeze_rpythonic_struct( CvEHMMState, [
	( "num_mix", ctypes.c_int ),
	( "mu", ctypes.POINTER(ctypes.c_float) ),
	( "inv_var", ctypes.POINTER(ctypes.c_float) ),
	( "log_var_val", ctypes.POINTER(ctypes.c_float) ),
	( "weight", ctypes.POINTER(ctypes.c_float) ),
])

__freeze_rpythonic_struct( CvEHMM, [
	( "level", ctypes.c_int ),
	( "num_states", ctypes.c_int ),
	( "transP", ctypes.POINTER(ctypes.c_float) ),
	( "obsProb", ctypes.POINTER(ctypes.POINTER(ctypes.c_float)) ),
	( "u", u ),
])

__freeze_rpythonic_struct( u, [
	( "state", ctypes.POINTER(CvEHMMState) ),
	( "ehmm", ctypes.POINTER(CvEHMM) ),
])

__freeze_rpythonic_struct( CvGraphWeightedVtx, [
	( "flags", ctypes.c_int ),
	( "first", ctypes.POINTER(CvGraphEdge) ),
	( "weight", ctypes.c_float ),
])

__freeze_rpythonic_struct( CvGraphWeightedEdge, [
	( "flags", ctypes.c_int ),
	( "weight", ctypes.c_float ),
	( "next", ctypes.POINTER(( CvGraphEdge * 2 )) ),
	( "vtx", ctypes.POINTER(( CvGraphVtx * 2 )) ),
...
__freeze_rpythonic_struct( CvCliqueFinder, [
	( "graph", ctypes.POINTER(CvGraph) ),
	( "adj_matr", ctypes.POINTER(ctypes.POINTER(ctypes.c_int)) ),
	( "N", ctypes.c_int ),
	( "k", ctypes.c_int ),
	( "current_comp", ctypes.POINTER(ctypes.c_int) ),
	( "All", ctypes.POINTER(ctypes.POINTER(ctypes.c_int)) ),
	( "ne", ctypes.POINTER(ctypes.c_int) ),
	( "ce", ctypes.POINTER(ctypes.c_int) ),
	( "fixp", ctypes.POINTER(ctypes.c_int) ),
	( "nod", ctypes.POINTER(ctypes.c_int) ),
	( "s", ctypes.POINTER(ctypes.c_int) ),
	( "status", ctypes.c_int ),
	( "best_score", ctypes.c_int ),
	( "weighted", ctypes.c_int ),
	( "weighted_edges", ctypes.c_int ),
	( "best_weight", ctypes.c_float ),
	( "edge_weights", ctypes.POINTER(ctypes.c_float) ),
	( "vertex_weights", ctypes.POINTER(ctypes.c_float) ),
	( "cur_weight", ctypes.POINTER(ctypes.c_float) ),
	( "cand_weight", ctypes.POINTER(ctypes.c_float) ),
])

__freeze_rpythonic_struct( CvStereoLineCoeff, [
	( "Xcoef", ctypes.c_double ),
	( "XcoefA", ctypes.c_double ),
	( "XcoefB", ctypes.c_double ),
	( "XcoefAB", ctypes.c_double ),
	( "Ycoef", ctypes.c_double ),
	( "YcoefA", ctypes.c_double ),
	( "YcoefB", ctypes.c_double ),
	( "YcoefAB", ctypes.c_double ),
	( "Zcoef", ctypes.c_double ),
	( "ZcoefA", ctypes.c_double ),
	( "ZcoefB", ctypes.c_double ),
	( "ZcoefAB", ctypes.c_double ),
])

__freeze_rpythonic_struct( CvCamera, [
	( "imgSize", ( ctypes.c_float * 2 ) ),
	( "matrix", ( ctypes.c_float * 9 ) ),
	( "distortion", ( ctypes.c_float * 4 ) ),
	( "rotMatr", ( ctypes.c_float * 9 ) ),
	( "transVect", ( ctypes.c_float * 3 ) ),
])

__freeze_rpythonic_struct( CvStereoCamera, [
	( "camera", ctypes.POINTER(( CvCamera * 2 )) ),
	( "fundMatr", ( ctypes.c_float * 9 ) ),
	( "epipole", ( CvPoint3D32f * 2 ) ),
	( "quad", ( CvPoint2D32f * 2 ) ),
	( "coeffs", ( ctypes.c_double * 2 ) ),
	( "border", ( CvPoint2D32f * 2 ) ),
	( "warpSize", CvSize ),
	( "lineCoeffs", ctypes.POINTER(CvStereoLineCoeff) ),
	( "needSwapCameras", ctypes.c_int ),
	( "rotMatrix", ( ctypes.c_float * 9 ) ),
	( "transVector", ( ctypes.c_float * 3 ) ),
])

__freeze_rpythonic_struct( CvContourOrientation, [
	( "egvals", ( ctypes.c_float * 2 ) ),
	( "egvects", ( ctypes.c_float * 4 ) ),
	( "max", ctypes.c_float ),
	( "min", ctypes.c_float ),
	( "imax", ctypes.c_int ),
	( "imin", ctypes.c_int ),
...
__freeze_rpythonic_struct( CvGLCM, [
])

__freeze_rpythonic_struct( CvFaceTracker, [
])

__freeze_rpythonic_struct( CvFace, [
	( "MouthRect", CvRect ),
	( "LeftEyeRect", CvRect ),
	( "RightEyeRect", CvRect ),
])

__freeze_rpythonic_struct( Cv3dTracker2dTrackedObject, [
	( "C_id", ctypes.c_int ),
	( "p", CvPoint2D32f ),
])

__freeze_rpythonic_struct( Cv3dTrackerTrackedObject, [
	( "C_id", ctypes.c_int ),
	( "p", CvPoint3D32f ),
])

__freeze_rpythonic_struct( Cv3dTrackerCameraInfo, [
	( "valid", ctypes.c_ubyte ),
	( "mat", ( ctypes.c_float * 4 ) ),
	( "principal_point", CvPoint2D32f ),
])

__freeze_rpythonic_struct( Cv3dTrackerCameraIntrinsics, [
	( "principal_point", CvPoint2D32f ),
	( "focal_length", ( ctypes.c_float * 2 ) ),
	( "distortion", ( ctypes.c_float * 4 ) ),
])

__freeze_rpythonic_struct( CvVoronoiNode2D, [
	( "flags", ctypes.c_int ),
	( "next_free", ctypes.POINTER(CvVoronoiNode2D) ),
	( "pt", CvPoint2D32f ),
	( "radius", ctypes.c_float ),
])

__freeze_rpythonic_struct( CvVoronoiSite2D, [
	( "node", ctypes.POINTER(( CvVoronoiNode2D * 2 )) ),
	( "edge", ctypes.POINTER(( CvVoronoiEdge2D * 2 )) ),
	( "next", ctypes.POINTER(( CvVoronoiSite2D * 2 )) ),
])

__freeze_rpythonic_struct( CvVoronoiEdge2D, [
	( "node", ctypes.POINTER(( CvVoronoiNode2D * 2 )) ),
	( "site", ctypes.POINTER(( CvVoronoiSite2D * 2 )) ),
	( "next", ctypes.POINTER(( CvVoronoiEdge2D * 4 )) ),
])

__freeze_rpythonic_struct( CvVoronoiDiagram2D, [
	( "flags", ctypes.c_int ),
	( "header_size", ctypes.c_int ),
	( "h_prev", ctypes.POINTER(CvSeq) ),
	( "h_next", ctypes.POINTER(CvSeq) ),
	...
	( "active_count", ctypes.c_int ),
	( "edges", ctypes.POINTER(CvSet) ),
	( "sites", ctypes.POINTER(CvSet) ),
])

__freeze_rpythonic_struct( CvLCMEdge, [
	( "flags", ctypes.c_int ),
	( "weight", ctypes.c_float ),
	( "next", ctypes.POINTER(( CvGraphEdge * 2 )) ),
	( "vtx", ctypes.POINTER(( CvGraphVtx * 2 )) ),
	( "chain", ctypes.POINTER(CvSeq) ),
	( "width", ctypes.c_float ),
	( "index1", ctypes.c_int ),
	( "index2", ctypes.c_int ),
])

__freeze_rpythonic_struct( CvLCMNode, [
	( "flags", ctypes.c_int ),
	( "first", ctypes.POINTER(CvGraphEdge) ),
	( "contour", ctypes.POINTER(CvContour) ),
])

__freeze_rpythonic_struct( CvBGStatModel, [
	( "C_type", ctypes.c_int ),
	( "release", ctypes.CFUNCTYPE(ctypes.c_void_p, ctypes.POINTER(ctypes.POINTER(CvBGStatModel)),) ),
	( "update", ctypes.CFUNCTYPE(ctypes.c_int, ctypes.POINTER(_IplImage),ctypes.POINTER(CvBGStatModel),ctypes.c_double,) ),
	( "background", ctypes.POINTER(_IplImage) ),
	( "foreground", ctypes.POINTER(_IplImage) ),
	( "layers", ctypes.POINTER(ctypes.POINTER(_IplImage)) ),
	( "layer_count", ctypes.c_int ),
	( "storage", ctypes.POINTER(CvMemStorage) ),
	( "foreground_regions", ctypes.POINTER(CvSeq) ),
])

__freeze_rpythonic_struct( CvFGDStatModelParams, [
	( "Lc", ctypes.c_int ),
	( "N1c", ctypes.c_int ),
	( "N2c", ctypes.c_int ),
	( "Lcc", ctypes.c_int ),
	( "N1cc", ctypes.c_int ),
	( "N2cc", ctypes.c_int ),
	( "is_obj_without_holes", ctypes.c_int ),
	( "perform_morphing", ctypes.c_int ),
	( "alpha1", ctypes.c_float ),
	( "alpha2", ctypes.c_float ),
	( "alpha3", ctypes.c_float ),
	( "delta", ctypes.c_float ),
	( "T", ctypes.c_float ),
	( "minArea", ctypes.c_float ),
])

__freeze_rpythonic_struct( CvBGPixelCStatTable, [
	( "Pv", ctypes.c_float ),
	( "Pvb", ctypes.c_float ),
	( "v", ( ctypes.c_ubyte * 3 ) ),
])

__freeze_rpythonic_struct( CvBGPixelCCStatTable, [
	( "Pv", ctypes.c_float ),
	( "Pvb", ctypes.c_float ),
	( "v", ( ctypes.c_ubyte * 6 ) ),
])

__freeze_rpythonic_struct( CvBGPixelStat, [
	( "Pbc", ctypes.c_float ),
	( "Pbcc", ctypes.c_float ),
	( "ctable", ctypes.POINTER(CvBGPixelCStatTable) ),
	( "cctable", ctypes.POINTER(CvBGPixelCCStatTable) ),
	( "is_trained_st_model", ctypes.c_ubyte ),
	( "is_trained_dyn_model", ctypes.c_ubyte ),
])

__freeze_rpythonic_struct( CvFGDStatModel, [
	( "C_type", ctypes.c_int ),
	( "release", ctypes.CFUNCTYPE(ctypes.c_void_p, ctypes.POINTER(ctypes.POINTER(CvBGStatModel)),) ),
	( "update", ctypes.CFUNCTYPE(ctypes.c_int, ctypes.POINTER(_IplImage),ctypes.POINTER(CvBGStatModel),ctypes.c_double,) ),
	( "background", ctypes.POINTER(_IplImage) ),
	...
	( "storage", ctypes.POINTER(CvMemStorage) ),
	( "foreground_regions", ctypes.POINTER(CvSeq) ),
	( "pixel_stat", ctypes.POINTER(CvBGPixelStat) ),
	( "Ftd", ctypes.POINTER(_IplImage) ),
	( "Fbd", ctypes.POINTER(_IplImage) ),
	( "prev_frame", ctypes.POINTER(_IplImage) ),
	( "params", CvFGDStatModelParams ),
])

__freeze_rpythonic_struct( CvGaussBGStatModelParams, [
	( "win_size", ctypes.c_int ),
	( "n_gauss", ctypes.c_int ),
	( "bg_threshold", ctypes.c_double ),
	( "std_threshold", ctypes.c_double ),
	( "minArea", ctypes.c_double ),
	( "weight_init", ctypes.c_double ),
	( "variance_init", ctypes.c_double ),
])

__freeze_rpythonic_struct( CvGaussBGValues, [
	( "match_sum", ctypes.c_int ),
	( "weight", ctypes.c_double ),
	( "variance", ( ctypes.c_double * 3 ) ),
	( "mean", ( ctypes.c_double * 3 ) ),
])

__freeze_rpythonic_struct( CvGaussBGPoint, [
	( "g_values", ctypes.POINTER(CvGaussBGValues) ),
])

__freeze_rpythonic_struct( CvGaussBGModel, [
	( "C_type", ctypes.c_int ),
	( "release", ctypes.CFUNCTYPE(ctypes.c_void_p, ctypes.POINTER(ctypes.POINTER(CvBGStatModel)),) ),
	( "update", ctypes.CFUNCTYPE(ctypes.c_int, ctypes.POINTER(_IplImage),ctypes.POINTER(CvBGStatModel),ctypes.c_double,) ),
	( "background", ctypes.POINTER(_IplImage) ),
	...
	( "g_point", ctypes.POINTER(CvGaussBGPoint) ),
	( "countFrames", ctypes.c_int ),
])

__freeze_rpythonic_struct( CvBGCodeBookElem, [
	( "next", ctypes.POINTER(CvBGCodeBookElem) ),
	( "tLastUpdate", ctypes.c_int ),
	( "stale", ctypes.c_int ),
	( "boxMin", ( ctypes.c_ubyte * 3 ) ),
	( "boxMax", ( ctypes.c_ubyte * 3 ) ),
	( "learnMin", ( ctypes.c_ubyte * 3 ) ),
	( "learnMax", ( ctypes.c_ubyte * 3 ) ),
])

__freeze_rpythonic_struct( CvBGCodeBookModel, [
	( "size", CvSize ),
	( "t", ctypes.c_int ),
	( "cbBounds", ( ctypes.c_ubyte * 3 ) ),
	( "modMin", ( ctypes.c_ubyte * 3 ) ),
	( "modMax", ( ctypes.c_ubyte * 3 ) ),
	( "cbmap", ctypes.POINTER(ctypes.POINTER(CvBGCodeBookElem)) ),
	( "storage", ctypes.POINTER(CvMemStorage) ),
	( "freeList", ctypes.POINTER(CvBGCodeBookElem) ),
])

__freeze_rpythonic_struct( CvConDensation, [
	( "MP", ctypes.c_int ),
	( "DP", ctypes.c_int ),
	( "DynamMatr", ctypes.POINTER(ctypes.c_float) ),
	( "State", ctypes.POINTER(ctypes.c_float) ),
	( "SamplesNum", ctypes.c_int ),
	( "flSamples", ctypes.POINTER(ctypes.POINTER(ctypes.c_float)) ),
	( "flNewSamples", ctypes.POINTER(ctypes.POINTER(ctypes.c_float)) ),
	( "flConfidence", ctypes.POINTER(ctypes.c_float) ),
	( "flCumulative", ctypes.POINTER(ctypes.c_float) ),
	( "Temp", ctypes.POINTER(ctypes.c_float) ),
	( "RandomSample", ctypes.POINTER(ctypes.c_float) ),
	( "RandS", ctypes.POINTER(CvRandState) ),
])
...
cvInitPerspectiveTransform = _rpythonic_function_(		"cvInitPerspectiveTransform", ctypes.c_void_p, [
	("size",		CvSize),
	("vertex",		( CvPoint2D32f * 4 )),
	("matrix",		( ctypes.c_double * 3 )),
	("rectMap",		ctypes.POINTER(ctypes.c_void_p)),] )

cvMakeScanlines = _rpythonic_function_(		"cvMakeScanlines", ctypes.c_void_p, [
	("matrix",		ctypes.POINTER(CvMatrix3)),
	("img_size",		CvSize),
	("scanlines1",		ctypes.POINTER(ctypes.c_int)),
	("scanlines2",		ctypes.POINTER(ctypes.c_int)),
	("lengths1",		ctypes.POINTER(ctypes.c_int)),
	("lengths2",		ctypes.POINTER(ctypes.c_int)),
	("line_count",		ctypes.POINTER(ctypes.c_int)),] )

cvPreWarpImage = _rpythonic_function_(		"cvPreWarpImage", ctypes.c_void_p, [
	("line_count",		ctypes.c_int),
	("img",		ctypes.POINTER(_IplImage)),
	("dst",		ctypes.POINTER(ctypes.c_ubyte)),
	("dst_nums",		ctypes.POINTER(ctypes.c_int)),
	("scanlines",		ctypes.POINTER(ctypes.c_int)),] )

cvFindRuns = _rpythonic_function_(		"cvFindRuns", ctypes.c_void_p, [
	("line_count",		ctypes.c_int),
	("prewarp1",		ctypes.POINTER(ctypes.c_ubyte)),
	("prewarp2",		ctypes.POINTER(ctypes.c_ubyte)),
	("line_lengths1",		ctypes.POINTER(ctypes.c_int)),
	("line_lengths2",		ctypes.POINTER(ctypes.c_int)),
	("runs1",		ctypes.POINTER(ctypes.c_int)),
	("runs2",		ctypes.POINTER(ctypes.c_int)),
	("num_runs1",		ctypes.POINTER(ctypes.c_int)),
	("num_runs2",		ctypes.POINTER(ctypes.c_int)),] )

cvDynamicCorrespondMulti = _rpythonic_function_(		"cvDynamicCorrespondMulti", ctypes.c_void_p, [
	("line_count",		ctypes.c_int),
	("first",		ctypes.POINTER(ctypes.c_int)),
	("first_runs",		ctypes.POINTER(ctypes.c_int)),
	("second",		ctypes.POINTER(ctypes.c_int)),
	("second_runs",		ctypes.POINTER(ctypes.c_int)),
	("first_corr",		ctypes.POINTER(ctypes.c_int)),
	("second_corr",		ctypes.POINTER(ctypes.c_int)),] )

cvMakeAlphaScanlines = _rpythonic_function_(		"cvMakeAlphaScanlines", ctypes.c_void_p, [
	("scanlines1",		ctypes.POINTER(ctypes.c_int)),
	("scanlines2",		ctypes.POINTER(ctypes.c_int)),
	("scanlinesA",		ctypes.POINTER(ctypes.c_int)),
	("lengths",		ctypes.POINTER(ctypes.c_int)),
	("line_count",		ctypes.c_int),
	("alpha",		ctypes.c_float),] )

cvMorphEpilinesMulti = _rpythonic_function_(		"cvMorphEpilinesMulti", ctypes.c_void_p, [
	("line_count",		ctypes.c_int),
	("first_pix",		ctypes.POINTER(ctypes.c_ubyte)),
	("first_num",		ctypes.POINTER(ctypes.c_int)),
	("second_pix",		ctypes.POINTER(ctypes.c_ubyte)),
	("second_num",		ctypes.POINTER(ctypes.c_int)),
	("dst_pix",		ctypes.POINTER(ctypes.c_ubyte)),
...
cvPostWarpImage = _rpythonic_function_(		"cvPostWarpImage", ctypes.c_void_p, [
	("line_count",		ctypes.c_int),
	("src",		ctypes.POINTER(ctypes.c_ubyte)),
	("src_nums",		ctypes.POINTER(ctypes.c_int)),
	("img",		ctypes.POINTER(_IplImage)),
	("scanlines",		ctypes.POINTER(ctypes.c_int)),] )

cvDeleteMoire = _rpythonic_function_(		"cvDeleteMoire", ctypes.c_void_p, [
	("img",		ctypes.POINTER(_IplImage)),] )

CvReleaseBGStatModel = _rpythonic_function_(		"CvReleaseBGStatModel", ctypes.c_void_p, [
	("bg_model",		ctypes.POINTER(ctypes.POINTER(CvBGStatModel))),] )

CvUpdateBGStatModel = _rpythonic_function_(		"CvUpdateBGStatModel", ctypes.c_int, [
	("curr_frame",		ctypes.POINTER(_IplImage)),
	("bg_model",		ctypes.POINTER(CvBGStatModel)),
	("learningRate",		ctypes.c_double),] )

cvRefineForegroundMaskBySegm = _rpythonic_function_(		"cvRefineForegroundMaskBySegm", ctypes.c_void_p, [
	("segments",		ctypes.POINTER(CvSeq)),
	("bg_model",		ctypes.POINTER(CvBGStatModel)),] )

cvChangeDetection = _rpythonic_function_(		"cvChangeDetection", ctypes.c_int, [
	("prev_frame",		ctypes.POINTER(_IplImage)),
	("curr_frame",		ctypes.POINTER(_IplImage)),
	("change_mask",		ctypes.POINTER(_IplImage)),] )

cvCreateFGDStatModel = _rpythonic_function_(		"cvCreateFGDStatModel", ctypes.POINTER(CvBGStatModel), [
	("first_frame",		ctypes.POINTER(_IplImage)),
	("parameters",		ctypes.POINTER(CvFGDStatModelParams)),] )

cvCreateGaussianBGModel = _rpythonic_function_(		"cvCreateGaussianBGModel", ctypes.POINTER(CvBGStatModel), [
	("first_frame",		ctypes.POINTER(_IplImage)),
	("parameters",		ctypes.POINTER(CvGaussBGStatModelParams)),] )

cvCreateBGCodeBookModel = _rpythonic_function_(		"cvCreateBGCodeBookModel", ctypes.POINTER(CvBGCodeBookModel), [] )

cvReleaseBGCodeBookModel = _rpythonic_function_(		"cvReleaseBGCodeBookModel", ctypes.c_void_p, [
	("model",		ctypes.POINTER(ctypes.POINTER(CvBGCodeBookModel))),] )

cvBGCodeBookUpdate = _rpythonic_function_(		"cvBGCodeBookUpdate", ctypes.c_void_p, [
	("model",		ctypes.POINTER(CvBGCodeBookModel)),
	("image",		ctypes.POINTER(ctypes.c_void_p)),
	("roi",		CvRect),
	("mask",		ctypes.POINTER(ctypes.c_void_p)),] )

cvBGCodeBookDiff = _rpythonic_function_(		"cvBGCodeBookDiff", ctypes.c_int, [
	("model",		ctypes.POINTER(CvBGCodeBookModel)),
	("image",		ctypes.POINTER(ctypes.c_void_p)),
	("fgmask",		ctypes.POINTER(ctypes.c_void_p)),
	("roi",		CvRect),] )

cvBGCodeBookClearStale = _rpythonic_function_(		"cvBGCodeBookClearStale", ctypes.c_void_p, [
	("model",		ctypes.POINTER(CvBGCodeBookModel)),
	("staleThresh",		ctypes.c_int),
	("roi",		CvRect),
	("mask",		ctypes.POINTER(ctypes.c_void_p)),] )

cvSegmentFGMask = _rpythonic_function_(		"cvSegmentFGMask", ctypes.POINTER(CvSeq), [
	("fgmask",		ctypes.POINTER(ctypes.c_void_p)),
	("poly1Hull0",		ctypes.c_int),
	("perimScale",		ctypes.c_float),
	("storage",		ctypes.POINTER(CvMemStorage)),
	("offset",		CvPoint),] )

cvCreateConDensation = _rpythonic_function_(		"cvCreateConDensation", ctypes.POINTER(CvConDensation), [
	("dynam_params",		ctypes.c_int),
	("measure_params",		ctypes.c_int),
	("sample_count",		ctypes.c_int),] )

cvReleaseConDensation = _rpythonic_function_(		"cvReleaseConDensation", ctypes.c_void_p, [
	("condens",		ctypes.POINTER(ctypes.POINTER(CvConDensation))),] )

cvConDensUpdateByTime = _rpythonic_function_(		"cvConDensUpdateByTime", ctypes.c_void_p, [
	("condens",		ctypes.POINTER(CvConDensation)),] )

cvConDensInitSampleSet = _rpythonic_function_(		"cvConDensInitSampleSet", ctypes.c_void_p, [
	("condens",		ctypes.POINTER(CvConDensation)),
	("lower_bound",		ctypes.POINTER(CvMat)),
	("upper_bound",		ctypes.POINTER(CvMat)),] )
...
icvConvertWarpCoordinates = _rpythonic_function_(		"icvConvertWarpCoordinates", ctypes.c_int, [
	("coeffs",		( ctypes.c_double * 3 )),
	("cameraPoint",		ctypes.POINTER(CvPoint2D32f)),
	("warpPoint",		ctypes.POINTER(CvPoint2D32f)),
	("direction",		ctypes.c_int),] )

icvGetSymPoint3D = _rpythonic_function_(		"icvGetSymPoint3D", ctypes.c_int, [
	("pointCorner",		CvPoint3D64f),
	("point1",		CvPoint3D64f),
	("point2",		CvPoint3D64f),
	("pointSym2",		ctypes.POINTER(CvPoint3D64f)),] )

icvGetPieceLength3D = _rpythonic_function_(		"icvGetPieceLength3D", ctypes.c_void_p, [
	("point1",		CvPoint3D64f),
	("point2",		CvPoint3D64f),
	("dist",		ctypes.POINTER(ctypes.c_double)),] )

icvCompute3DPoint = _rpythonic_function_(		"icvCompute3DPoint", ctypes.c_int, [
	("alpha",		ctypes.c_double),
	("betta",		ctypes.c_double),
	("coeffs",		ctypes.POINTER(CvStereoLineCoeff)),
	("point",		ctypes.POINTER(CvPoint3D64f)),] )

icvCreateConvertMatrVect = _rpythonic_function_(		"icvCreateConvertMatrVect", ctypes.c_int, [
	("rotMatr1",		ctypes.POINTER(ctypes.c_double)),
	("transVect1",		ctypes.POINTER(ctypes.c_double)),
	("rotMatr2",		ctypes.POINTER(ctypes.c_double)),
	("transVect2",		ctypes.POINTER(ctypes.c_double)),
	("convRotMatr",		ctypes.POINTER(ctypes.c_double)),
	("convTransVect",		ctypes.POINTER(ctypes.c_double)),] )

icvConvertPointSystem = _rpythonic_function_(		"icvConvertPointSystem", ctypes.c_int, [
	("M2",		CvPoint3D64f),
	("M1",		ctypes.POINTER(CvPoint3D64f)),
	("rotMatr",		ctypes.POINTER(ctypes.c_double)),
	("transVect",		ctypes.POINTER(ctypes.c_double)),] )

icvComputeCoeffForStereo = _rpythonic_function_(		"icvComputeCoeffForStereo", ctypes.c_int, [
	("stereoCamera",		ctypes.POINTER(CvStereoCamera)),] )

icvGetCrossPieceVector = _rpythonic_function_(		"icvGetCrossPieceVector", ctypes.c_int, [
	("p1_start",		CvPoint2D32f),
	("p1_end",		CvPoint2D32f),
	("v2_start",		CvPoint2D32f),
	("v2_end",		CvPoint2D32f),
	("cross",		ctypes.POINTER(CvPoint2D32f)),] )

icvGetCrossLineDirect = _rpythonic_function_(		"icvGetCrossLineDirect", ctypes.c_int, [
	("p1",		CvPoint2D32f),
	("p2",		CvPoint2D32f),
	("a",		ctypes.c_float),
	("b",		ctypes.c_float),
...
icvDefinePointPosition = _rpythonic_function_(		"icvDefinePointPosition", ctypes.c_float, [
	("point1",		CvPoint2D32f),
	("point2",		CvPoint2D32f),
	("point",		CvPoint2D32f),] )

icvStereoCalibration = _rpythonic_function_(		"icvStereoCalibration", ctypes.c_int, [
	("numImages",		ctypes.c_int),
	("nums",		ctypes.POINTER(ctypes.c_int)),
	("imageSize",		CvSize),
	("imagePoints1",		ctypes.POINTER(CvPoint2D32f)),
	("imagePoints2",		ctypes.POINTER(CvPoint2D32f)),
	("objectPoints",		ctypes.POINTER(CvPoint3D32f)),
	("stereoparams",		ctypes.POINTER(CvStereoCamera)),] )

icvComputeRestStereoParams = _rpythonic_function_(		"icvComputeRestStereoParams", ctypes.c_int, [
	("stereoparams",		ctypes.POINTER(CvStereoCamera)),] )

cvComputePerspectiveMap = _rpythonic_function_(		"cvComputePerspectiveMap", ctypes.c_void_p, [
	("coeffs",		( ctypes.c_double * 3 )),
	("rectMapX",		ctypes.POINTER(ctypes.c_void_p)),
	("rectMapY",		ctypes.POINTER(ctypes.c_void_p)),] )

icvComCoeffForLine = _rpythonic_function_(		"icvComCoeffForLine", ctypes.c_int, [
	("point1",		CvPoint2D64f),
	("point2",		CvPoint2D64f),
	("point3",		CvPoint2D64f),
	("point4",		CvPoint2D64f),
	("camMatr1",		ctypes.POINTER(ctypes.c_double)),
	("rotMatr1",		ctypes.POINTER(ctypes.c_double)),
	("transVect1",		ctypes.POINTER(ctypes.c_double)),
	("camMatr2",		ctypes.POINTER(ctypes.c_double)),
	("rotMatr2",		ctypes.POINTER(ctypes.c_double)),
	("transVect2",		ctypes.POINTER(ctypes.c_double)),
	("coeffs",		ctypes.POINTER(CvStereoLineCoeff)),
	("needSwapCameras",		ctypes.POINTER(ctypes.c_int)),] )

icvGetDirectionForPoint = _rpythonic_function_(		"icvGetDirectionForPoint", ctypes.c_int, [
	("point",		CvPoint2D64f),
	("camMatr",		ctypes.POINTER(ctypes.c_double)),
	("direct",		ctypes.POINTER(CvPoint3D64f)),] )

icvGetCrossLines = _rpythonic_function_(		"icvGetCrossLines", ctypes.c_int, [
	("point11",		CvPoint3D64f),
	("point12",		CvPoint3D64f),
	("point21",		CvPoint3D64f),
	("point22",		CvPoint3D64f),
	("midPoint",		ctypes.POINTER(CvPoint3D64f)),] )

icvComputeStereoLineCoeffs = _rpythonic_function_(		"icvComputeStereoLineCoeffs", ctypes.c_int, [
	("pointA",		CvPoint3D64f),
	("pointB",		CvPoint3D64f),
	("pointCam1",		CvPoint3D64f),
	("gamma",		ctypes.c_double),
	("coeffs",		ctypes.POINTER(CvStereoLineCoeff)),] )

icvGetAngleLine = _rpythonic_function_(		"icvGetAngleLine", ctypes.c_int, [
	("startPoint",		CvPoint2D64f),
	("imageSize",		CvSize),
	("point1",		ctypes.POINTER(CvPoint2D64f)),
	("point2",		ctypes.POINTER(CvPoint2D64f)),] )

icvGetCoefForPiece = _rpythonic_function_(		"icvGetCoefForPiece", ctypes.c_void_p, [
	("p_start",		CvPoint2D64f),
	("p_end",		CvPoint2D64f),
...
icvComputeeInfiniteProject1 = _rpythonic_function_(		"icvComputeeInfiniteProject1", ctypes.c_void_p, [
	("rotMatr",		ctypes.POINTER(ctypes.c_double)),
	("camMatr1",		ctypes.POINTER(ctypes.c_double)),
	("camMatr2",		ctypes.POINTER(ctypes.c_double)),
	("point1",		CvPoint2D32f),
	("point2",		ctypes.POINTER(CvPoint2D32f)),] )

icvComputeeInfiniteProject2 = _rpythonic_function_(		"icvComputeeInfiniteProject2", ctypes.c_void_p, [
	("rotMatr",		ctypes.POINTER(ctypes.c_double)),
	("camMatr1",		ctypes.POINTER(ctypes.c_double)),
	("camMatr2",		ctypes.POINTER(ctypes.c_double)),
	("point1",		ctypes.POINTER(CvPoint2D32f)),
	("point2",		CvPoint2D32f),] )

icvGetCrossDirectDirect = _rpythonic_function_(		"icvGetCrossDirectDirect", ctypes.c_void_p, [
	("direct1",		ctypes.POINTER(ctypes.c_double)),
	("direct2",		ctypes.POINTER(ctypes.c_double)),
	("cross",		ctypes.POINTER(CvPoint2D64f)),
	("result",		ctypes.POINTER(ctypes.c_int)),] )

icvGetCrossPieceDirect = _rpythonic_function_(		"icvGetCrossPieceDirect", ctypes.c_void_p, [
	("p_start",		CvPoint2D64f),
	("p_end",		CvPoint2D64f),
	("a",		ctypes.c_double),
	("b",		ctypes.c_double),
...
icvGetCrossPiecePiece = _rpythonic_function_(		"icvGetCrossPiecePiece", ctypes.c_void_p, [
	("p1_start",		CvPoint2D64f),
	("p1_end",		CvPoint2D64f),
	("p2_start",		CvPoint2D64f),
	("p2_end",		CvPoint2D64f),
	("cross",		ctypes.POINTER(CvPoint2D64f)),
	("result",		ctypes.POINTER(ctypes.c_int)),] )

icvGetPieceLength = _rpythonic_function_(		"icvGetPieceLength", ctypes.c_void_p, [
	("point1",		CvPoint2D64f),
	("point2",		CvPoint2D64f),
	("dist",		ctypes.POINTER(ctypes.c_double)),] )

icvGetCrossRectDirect = _rpythonic_function_(		"icvGetCrossRectDirect", ctypes.c_void_p, [
	("imageSize",		CvSize),
	("a",		ctypes.c_double),
	("b",		ctypes.c_double),
	("c",		ctypes.c_double),
	("start",		ctypes.POINTER(CvPoint2D64f)),
	("end",		ctypes.POINTER(CvPoint2D64f)),
	("result",		ctypes.POINTER(ctypes.c_int)),] )

icvProjectPointToImage = _rpythonic_function_(		"icvProjectPointToImage", ctypes.c_void_p, [
	("point",		CvPoint3D64f),
	("camMatr",		ctypes.POINTER(ctypes.c_double)),
	("rotMatr",		ctypes.POINTER(ctypes.c_double)),
	("transVect",		ctypes.POINTER(ctypes.c_double)),
	("projPoint",		ctypes.POINTER(CvPoint2D64f)),] )

icvGetQuadsTransform = _rpythonic_function_(		"icvGetQuadsTransform", ctypes.c_void_p, [
	("imageSize",		CvSize),
	("camMatr1",		ctypes.POINTER(ctypes.c_double)),
	("rotMatr1",		ctypes.POINTER(ctypes.c_double)),
	("transVect1",		ctypes.POINTER(ctypes.c_double)),
	...
	("rotMatr2",		ctypes.POINTER(ctypes.c_double)),
	("transVect2",		ctypes.POINTER(ctypes.c_double)),
	("warpSize",		ctypes.POINTER(CvSize)),
	("quad1",		( ctypes.c_double * 4 )),
	("quad2",		( ctypes.c_double * 4 )),
	("fundMatr",		ctypes.POINTER(ctypes.c_double)),
	("epipole1",		ctypes.POINTER(CvPoint3D64f)),
	("epipole2",		ctypes.POINTER(CvPoint3D64f)),] )

icvGetQuadsTransformStruct = _rpythonic_function_(		"icvGetQuadsTransformStruct", ctypes.c_void_p, [
	("stereoCamera",		ctypes.POINTER(CvStereoCamera)),] )

icvComputeStereoParamsForCameras = _rpythonic_function_(		"icvComputeStereoParamsForCameras", ctypes.c_void_p, [
	("stereoCamera",		ctypes.POINTER(CvStereoCamera)),] )

icvGetCutPiece = _rpythonic_function_(		"icvGetCutPiece", ctypes.c_void_p, [
	("areaLineCoef1",		ctypes.POINTER(ctypes.c_double)),
	("areaLineCoef2",		ctypes.POINTER(ctypes.c_double)),
	("epipole",		CvPoint2D64f),
	("imageSize",		CvSize),
	("point11",		ctypes.POINTER(CvPoint2D64f)),
	("point12",		ctypes.POINTER(CvPoint2D64f)),
	("point21",		ctypes.POINTER(CvPoint2D64f)),
	("point22",		ctypes.POINTER(CvPoint2D64f)),
	("result",		ctypes.POINTER(ctypes.c_int)),] )

icvGetMiddleAnglePoint = _rpythonic_function_(		"icvGetMiddleAnglePoint", ctypes.c_void_p, [
	("basePoint",		CvPoint2D64f),
	("point1",		CvPoint2D64f),
	("point2",		CvPoint2D64f),
	("midPoint",		ctypes.POINTER(CvPoint2D64f)),] )

icvGetNormalDirect = _rpythonic_function_(		"icvGetNormalDirect", ctypes.c_void_p, [
	("direct",		ctypes.POINTER(ctypes.c_double)),
	("point",		CvPoint2D64f),
	("normDirect",		ctypes.POINTER(ctypes.c_double)),] )

icvGetVect = _rpythonic_function_(		"icvGetVect", ctypes.c_double, [
	("basePoint",		CvPoint2D64f),
	("point1",		CvPoint2D64f),
	("point2",		CvPoint2D64f),] )

icvProjectPointToDirect = _rpythonic_function_(		"icvProjectPointToDirect", ctypes.c_void_p, [
	("point",		CvPoint2D64f),
	("lineCoeff",		ctypes.POINTER(ctypes.c_double)),
	("projectPoint",		ctypes.POINTER(CvPoint2D64f)),] )

icvGetDistanceFromPointToDirect = _rpythonic_function_(		"icvGetDistanceFromPointToDirect", ctypes.c_void_p, [
	("point",		CvPoint2D64f),
	("lineCoef",		ctypes.POINTER(ctypes.c_double)),
	("dist",		ctypes.POINTER(ctypes.c_double)),] )

icvCreateIsometricImage = _rpythonic_function_(		"icvCreateIsometricImage", ctypes.POINTER(_IplImage), [
	("src",		ctypes.POINTER(_IplImage)),
	("dst",		ctypes.POINTER(_IplImage)),
	("desired_depth",		ctypes.c_int),
	("desired_num_channels",		ctypes.c_int),] )

cvDeInterlace = _rpythonic_function_(		"cvDeInterlace", ctypes.c_void_p, [
	("frame",		ctypes.POINTER(ctypes.c_void_p)),
	("fieldEven",		ctypes.POINTER(ctypes.c_void_p)),
	("fieldOdd",		ctypes.POINTER(ctypes.c_void_p)),] )

cvCalcContoursCorrespondence = _rpythonic_function_(		"cvCalcContoursCorrespondence", ctypes.POINTER(CvSeq), [
	("contour1",		ctypes.POINTER(CvSeq)),
	("contour2",		ctypes.POINTER(CvSeq)),
	("storage",		ctypes.POINTER(CvMemStorage)),] )

cvMorphContours = _rpythonic_function_(		"cvMorphContours", ctypes.POINTER(CvSeq), [
	("contour1",		ctypes.POINTER(CvSeq)),
	("contour2",		ctypes.POINTER(CvSeq)),
	("corr",		ctypes.POINTER(CvSeq)),
	("alpha",		ctypes.c_double),
	("storage",		ctypes.POINTER(CvMemStorage)),] )

cvCreateGLCM = _rpythonic_function_(		"cvCreateGLCM", ctypes.POINTER(CvGLCM), [
	("srcImage",		ctypes.POINTER(_IplImage)),
	("stepMagnitude",		ctypes.c_int),
	("stepDirections",		ctypes.POINTER(ctypes.c_int)),
	("numStepDirections",		ctypes.c_int),
	("optimizationType",		ctypes.c_int),] )

cvReleaseGLCM = _rpythonic_function_(		"cvReleaseGLCM", ctypes.c_void_p, [
	("GLCM",		ctypes.POINTER(ctypes.POINTER(CvGLCM))),
	("flag",		ctypes.c_int),] )

cvCreateGLCMDescriptors = _rpythonic_function_(		"cvCreateGLCMDescriptors", ctypes.c_void_p, [
	("destGLCM",		ctypes.POINTER(CvGLCM)),
	("descriptorOptimizationType",		ctypes.c_int),] )

cvGetGLCMDescriptor = _rpythonic_function_(		"cvGetGLCMDescriptor", ctypes.c_double, [
	("GLCM",		ctypes.POINTER(CvGLCM)),
	("step",		ctypes.c_int),
	("descriptor",		ctypes.c_int),] )

cvGetGLCMDescriptorStatistics = _rpythonic_function_(		"cvGetGLCMDescriptorStatistics", ctypes.c_void_p, [
	("GLCM",		ctypes.POINTER(CvGLCM)),
	("descriptor",		ctypes.c_int),
	("average",		ctypes.POINTER(ctypes.c_double)),
	("standardDeviation",		ctypes.POINTER(ctypes.c_double)),] )

cvCreateGLCMImage = _rpythonic_function_(		"cvCreateGLCMImage", ctypes.POINTER(_IplImage), [
	("GLCM",		ctypes.POINTER(CvGLCM)),
	("step",		ctypes.c_int),] )

cvInitFaceTracker = _rpythonic_function_(		"cvInitFaceTracker", ctypes.POINTER(CvFaceTracker), [
	("pFaceTracking",		ctypes.POINTER(CvFaceTracker)),
	("imgGray",		ctypes.POINTER(_IplImage)),
	("pRects",		ctypes.POINTER(CvRect)),
	("nRects",		ctypes.c_int),] )

cvTrackFace = _rpythonic_function_(		"cvTrackFace", ctypes.c_int, [
	("pFaceTracker",		ctypes.POINTER(CvFaceTracker)),
	("imgGray",		ctypes.POINTER(_IplImage)),
	("pRects",		ctypes.POINTER(CvRect)),
	("nRects",		ctypes.c_int),
	("ptRotate",		ctypes.POINTER(CvPoint)),
	("dbAngleRotate",		ctypes.POINTER(ctypes.c_double)),] )

cvReleaseFaceTracker = _rpythonic_function_(		"cvReleaseFaceTracker", ctypes.c_void_p, [
	("ppFaceTracker",		ctypes.POINTER(ctypes.POINTER(CvFaceTracker))),] )

cvFindFace = _rpythonic_function_(		"cvFindFace", ctypes.POINTER(CvSeq), [
	("Image",		ctypes.POINTER(_IplImage)),
	("storage",		ctypes.POINTER(CvMemStorage)),] )

cvPostBoostingFindFace = _rpythonic_function_(		"cvPostBoostingFindFace", ctypes.POINTER(CvSeq), [
	("Image",		ctypes.POINTER(_IplImage)),
	("storage",		ctypes.POINTER(CvMemStorage)),] )

cv3dTrackerCalibrateCameras = _rpythonic_function_(		"cv3dTrackerCalibrateCameras", ctypes.c_ubyte, [
	("num_cameras",		ctypes.c_int),
	("camera_intrinsics",		Cv3dTrackerCameraIntrinsics),
	("etalon_size",		CvSize),
	("square_size",		ctypes.c_float),
	("samples",		ctypes.POINTER(_IplImage)),
	("camera_info",		Cv3dTrackerCameraInfo),] )

cv3dTrackerLocateObjects = _rpythonic_function_(		"cv3dTrackerLocateObjects", ctypes.c_int, [
	("num_cameras",		ctypes.c_int),
	("num_objects",		ctypes.c_int),
	("camera_info",		Cv3dTrackerCameraInfo),
	("tracking_info",		Cv3dTracker2dTrackedObject),
	("tracked_objects",		Cv3dTrackerTrackedObject),] )

cvVoronoiDiagramFromContour = _rpythonic_function_(		"cvVoronoiDiagramFromContour", ctypes.c_int, [
	("ContourSeq",		ctypes.POINTER(CvSeq)),
	("VoronoiDiagram",		ctypes.POINTER(ctypes.POINTER(CvVoronoiDiagram2D))),
	("VoronoiStorage",		ctypes.POINTER(CvMemStorage)),
	("contour_type",		ctypes.c_int),
	("contour_orientation",		ctypes.c_int),
	("attempt_number",		ctypes.c_int),] )

cvVoronoiDiagramFromImage = _rpythonic_function_(		"cvVoronoiDiagramFromImage", ctypes.c_int, [
	("pImage",		ctypes.POINTER(_IplImage)),
	("ContourSeq",		ctypes.POINTER(ctypes.POINTER(CvSeq))),
	("VoronoiDiagram",		ctypes.POINTER(ctypes.POINTER(CvVoronoiDiagram2D))),
	("VoronoiStorage",		ctypes.POINTER(CvMemStorage)),
	("regularization_method",		ctypes.c_int),
	("approx_precision",		ctypes.c_float),] )

cvReleaseVoronoiStorage = _rpythonic_function_(		"cvReleaseVoronoiStorage", ctypes.c_void_p, [
	("VoronoiDiagram",		ctypes.POINTER(CvVoronoiDiagram2D)),
	("pVoronoiStorage",		ctypes.POINTER(ctypes.POINTER(CvMemStorage))),] )

cvLinearContorModelFromVoronoiDiagram = _rpythonic_function_(		"cvLinearContorModelFromVoronoiDiagram", ctypes.POINTER(CvGraph), [
	("VoronoiDiagram",		ctypes.POINTER(CvVoronoiDiagram2D)),
	("maxWidth",		ctypes.c_float),] )

cvReleaseLinearContorModelStorage = _rpythonic_function_(		"cvReleaseLinearContorModelStorage", ctypes.c_int, [
	("Graph",		ctypes.POINTER(ctypes.POINTER(CvGraph))),] )

cvSegmentImage = _rpythonic_function_(		"cvSegmentImage", ctypes.POINTER(CvSeq), [
	("srcarr",		ctypes.POINTER(ctypes.c_void_p)),
	("dstarr",		ctypes.POINTER(ctypes.c_void_p)),
	("canny_threshold",		ctypes.c_double),
	("ffill_threshold",		ctypes.c_double),
	("storage",		ctypes.POINTER(CvMemStorage)),] )

CvCallback = _rpythonic_function_(		"CvCallback", ctypes.c_int, [
	("index",		ctypes.c_int),
	("buffer",		ctypes.POINTER(ctypes.c_void_p)),
	("user_data",		ctypes.POINTER(ctypes.c_void_p)),] )

cvCalcCovarMatrixEx = _rpythonic_function_(		"cvCalcCovarMatrixEx", ctypes.c_void_p, [
	("nObjects",		ctypes.c_int),
	("input",		ctypes.POINTER(ctypes.c_void_p)),
	("ioFlags",		ctypes.c_int),
	("ioBufSize",		ctypes.c_int),
	("buffer",		ctypes.POINTER(ctypes.c_ubyte)),
	("userData",		ctypes.POINTER(ctypes.c_void_p)),
	("avg",		ctypes.POINTER(_IplImage)),
	("covarMatrix",		ctypes.POINTER(ctypes.c_float)),] )

cvCalcEigenObjects = _rpythonic_function_(		"cvCalcEigenObjects", ctypes.c_void_p, [
	("nObjects",		ctypes.c_int),
	("input",		ctypes.POINTER(ctypes.c_void_p)),
	...
	("ioBufSize",		ctypes.c_int),
	("userData",		ctypes.POINTER(ctypes.c_void_p)),
	("calcLimit",		ctypes.POINTER(CvTermCriteria)),
	("avg",		ctypes.POINTER(_IplImage)),
	("eigVals",		ctypes.POINTER(ctypes.c_float)),] )

cvCalcDecompCoeff = _rpythonic_function_(		"cvCalcDecompCoeff", ctypes.c_double, [
	("obj",		ctypes.POINTER(_IplImage)),
	("eigObj",		ctypes.POINTER(_IplImage)),
	("avg",		ctypes.POINTER(_IplImage)),] )

cvEigenDecomposite = _rpythonic_function_(		"cvEigenDecomposite", ctypes.c_void_p, [
	("obj",		ctypes.POINTER(_IplImage)),
	("nEigObjs",		ctypes.c_int),
	("eigInput",		ctypes.POINTER(ctypes.c_void_p)),
	("ioFlags",		ctypes.c_int),
	("userData",		ctypes.POINTER(ctypes.c_void_p)),
	("avg",		ctypes.POINTER(_IplImage)),
	("coeffs",		ctypes.POINTER(ctypes.c_float)),] )

cvEigenProjection = _rpythonic_function_(		"cvEigenProjection", ctypes.c_void_p, [
	("eigInput",		ctypes.POINTER(ctypes.c_void_p)),
	("nEigObjs",		ctypes.c_int),
	("ioFlags",		ctypes.c_int),
	("userData",		ctypes.POINTER(ctypes.c_void_p)),
	("coeffs",		ctypes.POINTER(ctypes.c_float)),
	("avg",		ctypes.POINTER(_IplImage)),
	("proj",		ctypes.POINTER(_IplImage)),] )

cvCreate2DHMM = _rpythonic_function_(		"cvCreate2DHMM", ctypes.POINTER(CvEHMM), [
	("stateNumber",		ctypes.POINTER(ctypes.c_int)),
	("numMix",		ctypes.POINTER(ctypes.c_int)),
	("obsSize",		ctypes.c_int),] )

cvRelease2DHMM = _rpythonic_function_(		"cvRelease2DHMM", ctypes.c_void_p, [
	("hmm",		ctypes.POINTER(ctypes.POINTER(CvEHMM))),] )

cvCreateObsInfo = _rpythonic_function_(		"cvCreateObsInfo", ctypes.POINTER(CvImgObsInfo), [
	("numObs",		CvSize),
	("obsSize",		ctypes.c_int),] )

cvReleaseObsInfo = _rpythonic_function_(		"cvReleaseObsInfo", ctypes.c_void_p, [
	("obs_info",		ctypes.POINTER(ctypes.POINTER(CvImgObsInfo))),] )

cvImgToObs_DCT = _rpythonic_function_(		"cvImgToObs_DCT", ctypes.c_void_p, [
	("arr",		ctypes.POINTER(ctypes.c_void_p)),
	("obs",		ctypes.POINTER(ctypes.c_float)),
	("dctSize",		CvSize),
	("obsSize",		CvSize),
...
cvUniformImgSegm = _rpythonic_function_(		"cvUniformImgSegm", ctypes.c_void_p, [
	("obs_info",		ctypes.POINTER(CvImgObsInfo)),
	("ehmm",		ctypes.POINTER(CvEHMM)),] )

cvInitMixSegm = _rpythonic_function_(		"cvInitMixSegm", ctypes.c_void_p, [
	("obs_info_array",		ctypes.POINTER(ctypes.POINTER(CvImgObsInfo))),
	("num_img",		ctypes.c_int),
	("hmm",		ctypes.POINTER(CvEHMM)),] )

cvEstimateHMMStateParams = _rpythonic_function_(		"cvEstimateHMMStateParams", ctypes.c_void_p, [
	("obs_info_array",		ctypes.POINTER(ctypes.POINTER(CvImgObsInfo))),
	("num_img",		ctypes.c_int),
	("hmm",		ctypes.POINTER(CvEHMM)),] )

cvEstimateTransProb = _rpythonic_function_(		"cvEstimateTransProb", ctypes.c_void_p, [
	("obs_info_array",		ctypes.POINTER(ctypes.POINTER(CvImgObsInfo))),
	("num_img",		ctypes.c_int),
	("hmm",		ctypes.POINTER(CvEHMM)),] )

cvEstimateObsProb = _rpythonic_function_(		"cvEstimateObsProb", ctypes.c_void_p, [
	("obs_info",		ctypes.POINTER(CvImgObsInfo)),
	("hmm",		ctypes.POINTER(CvEHMM)),] )

cvEViterbi = _rpythonic_function_(		"cvEViterbi", ctypes.c_float, [
	("obs_info",		ctypes.POINTER(CvImgObsInfo)),
	("hmm",		ctypes.POINTER(CvEHMM)),] )

cvMixSegmL2 = _rpythonic_function_(		"cvMixSegmL2", ctypes.c_void_p, [
	("obs_info_array",		ctypes.POINTER(ctypes.POINTER(CvImgObsInfo))),
	("num_img",		ctypes.c_int),
	("hmm",		ctypes.POINTER(CvEHMM)),] )

cvCreateHandMask = _rpythonic_function_(		"cvCreateHandMask", ctypes.c_void_p, [
	("hand_points",		ctypes.POINTER(CvSeq)),
	("img_mask",		ctypes.POINTER(_IplImage)),
	("roi",		ctypes.POINTER(CvRect)),] )

cvFindHandRegion = _rpythonic_function_(		"cvFindHandRegion", ctypes.c_void_p, [
	("points",		ctypes.POINTER(CvPoint3D32f)),
	("count",		ctypes.c_int),
	("indexs",		ctypes.POINTER(CvSeq)),
	("line",		ctypes.POINTER(ctypes.c_float)),
	("size",		CvSize2D32f),
	("flag",		ctypes.c_int),
	("center",		ctypes.POINTER(CvPoint3D32f)),
	("storage",		ctypes.POINTER(CvMemStorage)),
	("numbers",		ctypes.POINTER(ctypes.POINTER(CvSeq))),] )

cvFindHandRegionA = _rpythonic_function_(		"cvFindHandRegionA", ctypes.c_void_p, [
	("points",		ctypes.POINTER(CvPoint3D32f)),
	("count",		ctypes.c_int),
	("indexs",		ctypes.POINTER(CvSeq)),
	("line",		ctypes.POINTER(ctypes.c_float)),
...
cvCalcImageHomography = _rpythonic_function_(		"cvCalcImageHomography", ctypes.c_void_p, [
	("line",		ctypes.POINTER(ctypes.c_float)),
	("center",		ctypes.POINTER(CvPoint3D32f)),
	("intrinsic",		ctypes.POINTER(ctypes.c_float)),
	("homography",		ctypes.POINTER(ctypes.c_float)),] )

icvDrawMosaic = _rpythonic_function_(		"icvDrawMosaic", ctypes.c_void_p, [
	("subdiv",		ctypes.POINTER(CvSubdiv2D)),
	("src",		ctypes.POINTER(_IplImage)),
	("dst",		ctypes.POINTER(_IplImage)),] )

icvSubdiv2DCheck = _rpythonic_function_(		"icvSubdiv2DCheck", ctypes.c_int, [
	("subdiv",		ctypes.POINTER(CvSubdiv2D)),] )

cvCalcPGH = _rpythonic_function_(		"cvCalcPGH", ctypes.c_void_p, [
	("contour",		ctypes.POINTER(CvSeq)),
	("hist",		ctypes.POINTER(CvHistogram)),] )

cvFindDominantPoints = _rpythonic_function_(		"cvFindDominantPoints", ctypes.POINTER(CvSeq), [
	("contour",		ctypes.POINTER(CvSeq)),
	("storage",		ctypes.POINTER(CvMemStorage)),
	("method",		ctypes.c_int),
	("parameter1",		ctypes.c_double),
	("parameter2",		ctypes.c_double),
	("parameter3",		ctypes.c_double),
	("parameter4",		ctypes.c_double),] )

cvFindStereoCorrespondence = _rpythonic_function_(		"cvFindStereoCorrespondence", ctypes.c_void_p, [
	("leftImage",		ctypes.POINTER(ctypes.c_void_p)),
	("rightImage",		ctypes.POINTER(ctypes.c_void_p)),
	("mode",		ctypes.c_int),
	("dispImage",		ctypes.POINTER(ctypes.c_void_p)),
	("maxDisparity",		ctypes.c_int),
	("param1",		ctypes.c_double),
	("param2",		ctypes.c_double),
