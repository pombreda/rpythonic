...
## macro globals ##
E_NPUTIL_DRIVER_ERROR = -1
E_NPUTIL_NOT_INITED = -2
E_NPUTIL_NOT_OPENED = -3
## enums ##
_codecvt_result = { 
	"__codecvt_ok" : 0, 
	"__codecvt_partial" : 1, 
...
class epoc_device(_rpythonic_struct_): pass
class epoc_contact_quality(_rpythonic_struct_): pass
class epoc_frame(_rpythonic_struct_): pass
...
__freeze_rpythonic_struct( __pthread_mutex_s, [
	...
	#opaque-warning# <rpythonic.rpythonic.SomeThing object at 0x91f6b6c>
])
...
__freeze_rpythonic_struct( epoc_device, [
	( "_context", ctypes.POINTER(libusb_context) ),
	( "_device", ctypes.POINTER(libusb_device_handle) ),
	( "_in_transfer", ctypes.POINTER(libusb_transfer) ),
	( "_out_transfer", ctypes.POINTER(libusb_transfer) ),
	( "_is_open", ctypes.c_int ),
	( "_is_inited", ctypes.c_int ),
])

__freeze_rpythonic_struct( epoc_contact_quality, [
	( "F3", ctypes.c_char ),
	( "FC6", ctypes.c_char ),
	( "P7", ctypes.c_char ),
	( "T8", ctypes.c_char ),
...
__freeze_rpythonic_struct( epoc_frame, [
	( "F3", ctypes.c_int ),
	( "FC6", ctypes.c_int ),
	( "P7", ctypes.c_int ),
	( "T8", ctypes.c_int ),
	...
	( "O1", ctypes.c_int ),
	( "FC5", ctypes.c_int ),
	( "cq", epoc_contact_quality ),
	( "gyroX", ctypes.c_char ),
	( "gyroY", ctypes.c_char ),
	( "battery", ctypes.c_char ),
])
...
epoc_init = _rpythonic_function_(		"epoc_init", ctypes.c_int, [
	("C_type",		ctypes.c_int),] )

epoc_deinit = _rpythonic_function_(		"epoc_deinit", ctypes.c_int, [] )

epoc_get_next_raw = _rpythonic_function_(		"epoc_get_next_raw", ctypes.c_int, [
	("raw_frame",		( ctypes.c_ubyte * 32 )),
	("raw_data",		ctypes.POINTER(ctypes.c_ubyte)),] )

epoc_get_next_frame = _rpythonic_function_(		"epoc_get_next_frame", ctypes.c_int, [
	("frame",		ctypes.POINTER(epoc_frame)),
	("raw_data",		ctypes.POINTER(ctypes.c_ubyte)),] )

epoc_create = _rpythonic_function_(		"epoc_create", ctypes.POINTER(epoc_device), [] )

epoc_get_count = _rpythonic_function_(		"epoc_get_count", ctypes.c_int, [
	("s",		ctypes.POINTER(epoc_device)),
	("device_vid",		ctypes.c_int),
	("device_pid",		ctypes.c_int),] )

epoc_open = _rpythonic_function_(		"epoc_open", ctypes.c_int, [
	("s",		ctypes.POINTER(epoc_device)),
	("device_vid",		ctypes.c_int),
	("device_pid",		ctypes.c_int),
	("device_index",		ctypes.c_uint),] )

epoc_close = _rpythonic_function_(		"epoc_close", ctypes.c_int, [
	("s",		ctypes.POINTER(epoc_device)),] )

epoc_delete = _rpythonic_function_(		"epoc_delete", ctypes.c_void_p, [
	("dev",		ctypes.POINTER(epoc_device)),] )

epoc_read_data = _rpythonic_function_(		"epoc_read_data", ctypes.c_int, [
	("dev",		ctypes.POINTER(epoc_device)),
	("input_report",		ctypes.POINTER(ctypes.c_uint8)),] )
