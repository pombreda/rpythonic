...
RPYTHONIC_GLOBAL_ENUMS = { 
 "IN_CLOEXEC" : 2000000,  "IN_NONBLOCK" : 4000, 

}
class inotify_event(_rpythonic_struct_): _array_wrapper_ = True
## union and structures ##
__freeze_rpythonic_struct( inotify_event, [
	( "wd", ctypes.c_int ),
...
## wrapper functions ##
inotify_init = _rpythonic_function_(		"inotify_init", ctypes.c_int, [] )

inotify_init1 = _rpythonic_function_(		"inotify_init1", ctypes.c_int, [
	("__flags",		ctypes.c_int),] )

inotify_add_watch = _rpythonic_function_(		"inotify_add_watch", ctypes.c_int, [
	("__fd",		ctypes.c_int),
	("__name",		ctypes.POINTER(ctypes.c_char)),
	("__mask",		ctypes.c_uint32),] )

inotify_rm_watch = _rpythonic_function_(		"inotify_rm_watch", ctypes.c_int, [
	("__fd",		ctypes.c_int),
	("__wd",		ctypes.c_int),] )
