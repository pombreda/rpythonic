...
class MonoDisHelper(_rpythonic_struct_): pass
class MonoMethodDesc(_rpythonic_struct_): pass
class MonoBundledAssembly(_rpythonic_struct_): pass
...
__freeze_rpythonic_struct( MonoDisHelper, [
	( "newline", ctypes.POINTER(ctypes.c_char) ),
	( "label_format", ctypes.POINTER(ctypes.c_char) ),
	( "label_target", ctypes.POINTER(ctypes.c_char) ),
	( "indenter", ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(MonoDisHelper),ctypes.POINTER(_MonoMethod),ctypes.c_uint32,)) ),
	( "tokener", ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.POINTER(ctypes.c_char), ctypes.POINTER(MonoDisHelper),ctypes.POINTER(_MonoMethod),ctypes.c_uint32,)) ),
	( "user_data", ctypes.POINTER(ctypes.c_void_p) ),
])

__freeze_rpythonic_struct( MonoMethodDesc, [
])

__freeze_rpythonic_struct( MonoBundledAssembly, [
...
mono_environment_exitcode_get = _rpythonic_function_(		"mono_environment_exitcode_get", ctypes.c_int32, [] )

mono_environment_exitcode_set = _rpythonic_function_(		"mono_environment_exitcode_set", ctypes.c_void_p, [
	("value",		ctypes.c_int32),] )

mono_get_config_dir = _rpythonic_function_(		"mono_get_config_dir", ctypes.POINTER(ctypes.c_char), [] )

mono_set_config_dir = _rpythonic_function_(		"mono_set_config_dir", ctypes.c_void_p, [
	("dir",		ctypes.POINTER(ctypes.c_char)),] )

mono_get_machine_config = _rpythonic_function_(		"mono_get_machine_config", ctypes.POINTER(ctypes.c_char), [] )

mono_config_cleanup = _rpythonic_function_(		"mono_config_cleanup", ctypes.c_void_p, [] )

mono_config_parse = _rpythonic_function_(		"mono_config_parse", ctypes.c_void_p, [
	("filename",		ctypes.POINTER(ctypes.c_char)),] )

mono_config_for_assembly = _rpythonic_function_(		"mono_config_for_assembly", ctypes.c_void_p, [
	("assembly",		ctypes.POINTER(_MonoImage)),] )

mono_config_parse_memory = _rpythonic_function_(		"mono_config_parse_memory", ctypes.c_void_p, [
	("buffer",		ctypes.POINTER(ctypes.c_char)),] )

mono_config_string_for_assembly_file = _rpythonic_function_(		"mono_config_string_for_assembly_file", ctypes.POINTER(ctypes.c_char), [
	("filename",		ctypes.POINTER(ctypes.c_char)),] )

MonoDisIndenter = _rpythonic_function_(		"MonoDisIndenter", ctypes.POINTER(ctypes.c_char), [
	("dh",		ctypes.POINTER(MonoDisHelper)),
	("method",		ctypes.POINTER(_MonoMethod)),
	("ip_offset",		ctypes.c_uint32),] )

MonoDisTokener = _rpythonic_function_(		"MonoDisTokener", ctypes.POINTER(ctypes.c_char), [
	("dh",		ctypes.POINTER(MonoDisHelper)),
	("method",		ctypes.POINTER(_MonoMethod)),
	("token",		ctypes.c_uint32),] )

mono_disasm_code = _rpythonic_function_(		"mono_disasm_code", ctypes.POINTER(ctypes.c_char), [
	("dh",		ctypes.POINTER(MonoDisHelper)),
	("method",		ctypes.POINTER(_MonoMethod)),
	("ip",		ctypes.POINTER(ctypes.c_uint8)),
	("end",		ctypes.POINTER(ctypes.c_uint8)),] )

mono_disasm_code_one = _rpythonic_function_(		"mono_disasm_code_one", ctypes.POINTER(ctypes.c_char), [
	("dh",		ctypes.POINTER(MonoDisHelper)),
	("method",		ctypes.POINTER(_MonoMethod)),
	("ip",		ctypes.POINTER(ctypes.c_uint8)),
	("endp",		ctypes.POINTER(ctypes.POINTER(ctypes.c_uint8))),] )

mono_type_full_name = _rpythonic_function_(		"mono_type_full_name", ctypes.POINTER(ctypes.c_char), [
	("C_type",		ctypes.POINTER(_MonoType)),] )

mono_signature_get_desc = _rpythonic_function_(		"mono_signature_get_desc", ctypes.POINTER(ctypes.c_char), [
	("sig",		ctypes.POINTER(_MonoMethodSignature)),
	("include_namespace",		ctypes.c_int32),] )

mono_context_get_desc = _rpythonic_function_(		"mono_context_get_desc", ctypes.POINTER(ctypes.c_char), [
	("context",		ctypes.POINTER(_MonoGenericContext)),] )

mono_method_desc_new = _rpythonic_function_(		"mono_method_desc_new", ctypes.POINTER(MonoMethodDesc), [
	("name",		ctypes.POINTER(ctypes.c_char)),
	("include_namespace",		ctypes.c_int32),] )

mono_method_desc_from_method = _rpythonic_function_(		"mono_method_desc_from_method", ctypes.POINTER(MonoMethodDesc), [
	("method",		ctypes.POINTER(_MonoMethod)),] )

mono_method_desc_free = _rpythonic_function_(		"mono_method_desc_free", ctypes.c_void_p, [
	("desc",		ctypes.POINTER(MonoMethodDesc)),] )

mono_method_desc_match = _rpythonic_function_(		"mono_method_desc_match", ctypes.c_int32, [
	("desc",		ctypes.POINTER(MonoMethodDesc)),
	("method",		ctypes.POINTER(_MonoMethod)),] )

mono_method_desc_full_match = _rpythonic_function_(		"mono_method_desc_full_match", ctypes.c_int32, [
	("desc",		ctypes.POINTER(MonoMethodDesc)),
	("method",		ctypes.POINTER(_MonoMethod)),] )

mono_method_desc_search_in_class = _rpythonic_function_(		"mono_method_desc_search_in_class", ctypes.POINTER(_MonoMethod), [
	("desc",		ctypes.POINTER(MonoMethodDesc)),
	("klass",		ctypes.POINTER(_MonoClass)),] )

mono_method_desc_search_in_image = _rpythonic_function_(		"mono_method_desc_search_in_image", ctypes.POINTER(_MonoMethod), [
	("desc",		ctypes.POINTER(MonoMethodDesc)),
	("image",		ctypes.POINTER(_MonoImage)),] )

mono_method_full_name = _rpythonic_function_(		"mono_method_full_name", ctypes.POINTER(ctypes.c_char), [
	("method",		ctypes.POINTER(_MonoMethod)),
	("signature",		ctypes.c_int32),] )

mono_field_full_name = _rpythonic_function_(		"mono_field_full_name", ctypes.POINTER(ctypes.c_char), [
	("field",		ctypes.POINTER(_MonoClassField)),] )

mono_assemblies_init = _rpythonic_function_(		"mono_assemblies_init", ctypes.c_void_p, [] )

mono_assemblies_cleanup = _rpythonic_function_(		"mono_assemblies_cleanup", ctypes.c_void_p, [] )

mono_assembly_open = _rpythonic_function_(		"mono_assembly_open", ctypes.POINTER(_MonoAssembly), [
	("filename",		ctypes.POINTER(ctypes.c_char)),
	("status",		ctypes.POINTER(ctypes.c_int)),] )

mono_assembly_open_full = _rpythonic_function_(		"mono_assembly_open_full", ctypes.POINTER(_MonoAssembly), [
	("filename",		ctypes.POINTER(ctypes.c_char)),
	("status",		ctypes.POINTER(ctypes.c_int)),
	("refonly",		ctypes.c_int32),] )

mono_assembly_load = _rpythonic_function_(		"mono_assembly_load", ctypes.POINTER(_MonoAssembly), [
	("aname",		ctypes.POINTER(_MonoAssemblyName)),
	("basedir",		ctypes.POINTER(ctypes.c_char)),
	("status",		ctypes.POINTER(ctypes.c_int)),] )

mono_assembly_load_full = _rpythonic_function_(		"mono_assembly_load_full", ctypes.POINTER(_MonoAssembly), [
	("aname",		ctypes.POINTER(_MonoAssemblyName)),
	("basedir",		ctypes.POINTER(ctypes.c_char)),
	("status",		ctypes.POINTER(ctypes.c_int)),
	("refonly",		ctypes.c_int32),] )

mono_assembly_load_from = _rpythonic_function_(		"mono_assembly_load_from", ctypes.POINTER(_MonoAssembly), [
	("image",		ctypes.POINTER(_MonoImage)),
	("fname",		ctypes.POINTER(ctypes.c_char)),
	("status",		ctypes.POINTER(ctypes.c_int)),] )

mono_assembly_load_from_full = _rpythonic_function_(		"mono_assembly_load_from_full", ctypes.POINTER(_MonoAssembly), [
	("image",		ctypes.POINTER(_MonoImage)),
	("fname",		ctypes.POINTER(ctypes.c_char)),
	("status",		ctypes.POINTER(ctypes.c_int)),
	("refonly",		ctypes.c_int32),] )

mono_assembly_load_with_partial_name = _rpythonic_function_(		"mono_assembly_load_with_partial_name", ctypes.POINTER(_MonoAssembly), [
	("name",		ctypes.POINTER(ctypes.c_char)),
	("status",		ctypes.POINTER(ctypes.c_int)),] )

mono_assembly_loaded = _rpythonic_function_(		"mono_assembly_loaded", ctypes.POINTER(_MonoAssembly), [
	("aname",		ctypes.POINTER(_MonoAssemblyName)),] )

mono_assembly_loaded_full = _rpythonic_function_(		"mono_assembly_loaded_full", ctypes.POINTER(_MonoAssembly), [
	("aname",		ctypes.POINTER(_MonoAssemblyName)),
	("refonly",		ctypes.c_int32),] )

mono_assembly_get_assemblyref = _rpythonic_function_(		"mono_assembly_get_assemblyref", ctypes.c_void_p, [
	("image",		ctypes.POINTER(_MonoImage)),
	("index",		ctypes.c_int),
	("aname",		ctypes.POINTER(_MonoAssemblyName)),] )

mono_assembly_load_reference = _rpythonic_function_(		"mono_assembly_load_reference", ctypes.c_void_p, [
	("image",		ctypes.POINTER(_MonoImage)),
	("index",		ctypes.c_int),] )

mono_assembly_load_references = _rpythonic_function_(		"mono_assembly_load_references", ctypes.c_void_p, [
	("image",		ctypes.POINTER(_MonoImage)),
	("status",		ctypes.POINTER(ctypes.c_int)),] )

mono_assembly_load_module = _rpythonic_function_(		"mono_assembly_load_module", ctypes.POINTER(_MonoImage), [
	("assembly",		ctypes.POINTER(_MonoAssembly)),
	("idx",		ctypes.c_uint32),] )

mono_assembly_close = _rpythonic_function_(		"mono_assembly_close", ctypes.c_void_p, [
	("assembly",		ctypes.POINTER(_MonoAssembly)),] )

mono_assembly_setrootdir = _rpythonic_function_(		"mono_assembly_setrootdir", ctypes.c_void_p, [
	("root_dir",		ctypes.POINTER(ctypes.c_char)),] )

mono_assembly_getrootdir = _rpythonic_function_(		"mono_assembly_getrootdir", ctypes.POINTER(ctypes.c_char), [] )

mono_assembly_foreach = _rpythonic_function_(		"mono_assembly_foreach", ctypes.c_void_p, [
	("func",		ctypes.CFUNCTYPE(ctypes.c_void_p, ctypes.POINTER(ctypes.c_void_p),ctypes.POINTER(ctypes.c_void_p),)),
	("user_data",		ctypes.POINTER(ctypes.c_void_p)),] )

mono_assembly_set_main = _rpythonic_function_(		"mono_assembly_set_main", ctypes.c_void_p, [
	("assembly",		ctypes.POINTER(_MonoAssembly)),] )

mono_assembly_get_main = _rpythonic_function_(		"mono_assembly_get_main", ctypes.POINTER(_MonoAssembly), [] )

mono_assembly_get_image = _rpythonic_function_(		"mono_assembly_get_image", ctypes.POINTER(_MonoImage), [
	("assembly",		ctypes.POINTER(_MonoAssembly)),] )

mono_assembly_fill_assembly_name = _rpythonic_function_(		"mono_assembly_fill_assembly_name", ctypes.c_int32, [
	("image",		ctypes.POINTER(_MonoImage)),
	("aname",		ctypes.POINTER(_MonoAssemblyName)),] )

mono_assembly_names_equal = _rpythonic_function_(		"mono_assembly_names_equal", ctypes.c_int32, [
	("l",		ctypes.POINTER(_MonoAssemblyName)),
	("r",		ctypes.POINTER(_MonoAssemblyName)),] )

mono_stringify_assembly_name = _rpythonic_function_(		"mono_stringify_assembly_name", ctypes.POINTER(ctypes.c_char), [
	("aname",		ctypes.POINTER(_MonoAssemblyName)),] )

MonoAssemblyLoadFunc = _rpythonic_function_(		"MonoAssemblyLoadFunc", ctypes.c_void_p, [
	("assembly",		ctypes.POINTER(_MonoAssembly)),
	("user_data",		ctypes.POINTER(ctypes.c_void_p)),] )

mono_install_assembly_load_hook = _rpythonic_function_(		"mono_install_assembly_load_hook", ctypes.c_void_p, [
	("func",		ctypes.CFUNCTYPE(ctypes.c_void_p, ctypes.POINTER(_MonoAssembly),ctypes.POINTER(ctypes.c_void_p),)),
	("user_data",		ctypes.POINTER(ctypes.c_void_p)),] )

MonoAssemblySearchFunc = _rpythonic_function_(		"MonoAssemblySearchFunc", ctypes.POINTER(_MonoAssembly), [
	("aname",		ctypes.POINTER(_MonoAssemblyName)),
	("user_data",		ctypes.POINTER(ctypes.c_void_p)),] )

mono_install_assembly_search_hook = _rpythonic_function_(		"mono_install_assembly_search_hook", ctypes.c_void_p, [
	("func",		ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.POINTER(_MonoAssembly), ctypes.POINTER(_MonoAssemblyName),ctypes.POINTER(ctypes.c_void_p),))),
	("user_data",		ctypes.POINTER(ctypes.c_void_p)),] )

mono_install_assembly_refonly_search_hook = _rpythonic_function_(		"mono_install_assembly_refonly_search_hook", ctypes.c_void_p, [
	("func",		ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.POINTER(_MonoAssembly), ctypes.POINTER(_MonoAssemblyName),ctypes.POINTER(ctypes.c_void_p),))),
	("user_data",		ctypes.POINTER(ctypes.c_void_p)),] )

mono_assembly_invoke_search_hook = _rpythonic_function_(		"mono_assembly_invoke_search_hook", ctypes.POINTER(_MonoAssembly), [
	("aname",		ctypes.POINTER(_MonoAssemblyName)),] )

mono_install_assembly_postload_search_hook = _rpythonic_function_(		"mono_install_assembly_postload_search_hook", ctypes.c_void_p, [
	("func",		ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.POINTER(_MonoAssembly), ctypes.POINTER(_MonoAssemblyName),ctypes.POINTER(ctypes.c_void_p),))),
	("user_data",		ctypes.POINTER(ctypes.c_void_p)),] )

mono_install_assembly_postload_refonly_search_hook = _rpythonic_function_(		"mono_install_assembly_postload_refonly_search_hook", ctypes.c_void_p, [
	("func",		ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.POINTER(_MonoAssembly), ctypes.POINTER(_MonoAssemblyName),ctypes.POINTER(ctypes.c_void_p),))),
	("user_data",		ctypes.POINTER(ctypes.c_void_p)),] )

MonoAssemblyPreLoadFunc = _rpythonic_function_(		"MonoAssemblyPreLoadFunc", ctypes.POINTER(_MonoAssembly), [
	("aname",		ctypes.POINTER(_MonoAssemblyName)),
	("assemblies_path",		ctypes.POINTER(ctypes.POINTER(ctypes.c_char))),
	("user_data",		ctypes.POINTER(ctypes.c_void_p)),] )

mono_install_assembly_preload_hook = _rpythonic_function_(		"mono_install_assembly_preload_hook", ctypes.c_void_p, [
	("func",		ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.POINTER(_MonoAssembly), ctypes.POINTER(_MonoAssemblyName),ctypes.POINTER(ctypes.POINTER(ctypes.c_char)),ctypes.POINTER(ctypes.c_void_p),))),
	("user_data",		ctypes.POINTER(ctypes.c_void_p)),] )

mono_install_assembly_refonly_preload_hook = _rpythonic_function_(		"mono_install_assembly_refonly_preload_hook", ctypes.c_void_p, [
	("func",		ctypes.POINTER(ctypes.CFUNCTYPE(ctypes.POINTER(_MonoAssembly), ctypes.POINTER(_MonoAssemblyName),ctypes.POINTER(ctypes.POINTER(ctypes.c_char)),ctypes.POINTER(ctypes.c_void_p),))),
	("user_data",		ctypes.POINTER(ctypes.c_void_p)),] )

mono_assembly_invoke_load_hook = _rpythonic_function_(		"mono_assembly_invoke_load_hook", ctypes.c_void_p, [
	("ass",		ctypes.POINTER(_MonoAssembly)),] )

mono_assembly_name_new = _rpythonic_function_(		"mono_assembly_name_new", ctypes.POINTER(_MonoAssemblyName), [
	("name",		ctypes.POINTER(ctypes.c_char)),] )

mono_assembly_name_get_name = _rpythonic_function_(		"mono_assembly_name_get_name", ctypes.POINTER(ctypes.c_char), [
	("aname",		ctypes.POINTER(_MonoAssemblyName)),] )

mono_assembly_name_get_culture = _rpythonic_function_(		"mono_assembly_name_get_culture", ctypes.POINTER(ctypes.c_char), [
	("aname",		ctypes.POINTER(_MonoAssemblyName)),] )

mono_assembly_name_get_version = _rpythonic_function_(		"mono_assembly_name_get_version", ctypes.c_uint16, [
	("aname",		ctypes.POINTER(_MonoAssemblyName)),
	("minor",		ctypes.POINTER(ctypes.c_uint16)),
	("build",		ctypes.POINTER(ctypes.c_uint16)),
	("revision",		ctypes.POINTER(ctypes.c_uint16)),] )

mono_assembly_name_get_pubkeytoken = _rpythonic_function_(		"mono_assembly_name_get_pubkeytoken", ctypes.POINTER(ctypes.c_uint8), [
	("aname",		ctypes.POINTER(_MonoAssemblyName)),] )

mono_assembly_name_free = _rpythonic_function_(		"mono_assembly_name_free", ctypes.c_void_p, [
	("aname",		ctypes.POINTER(_MonoAssemblyName)),] )

mono_register_bundled_assemblies = _rpythonic_function_(		"mono_register_bundled_assemblies", ctypes.c_void_p, [
	("assemblies",		ctypes.POINTER(ctypes.POINTER(MonoBundledAssembly))),] )

mono_register_config_for_assembly = _rpythonic_function_(		"mono_register_config_for_assembly", ctypes.c_void_p, [
	("assembly_name",		ctypes.POINTER(ctypes.c_char)),
	("config_xml",		ctypes.POINTER(ctypes.c_char)),] )

mono_register_symfile_for_assembly = _rpythonic_function_(		"mono_register_symfile_for_assembly", ctypes.c_void_p, [
	("assembly_name",		ctypes.POINTER(ctypes.c_char)),
	("raw_contents",		ctypes.POINTER(ctypes.c_uint8)),
	("size",		ctypes.c_int),] )

mono_register_machine_config = _rpythonic_function_(		"mono_register_machine_config", ctypes.c_void_p, [
	("config_xml",		ctypes.POINTER(ctypes.c_char)),] )

mono_set_rootdir = _rpythonic_function_(		"mono_set_rootdir", ctypes.c_void_p, [] )

mono_set_dirs = _rpythonic_function_(		"mono_set_dirs", ctypes.c_void_p, [
	("assembly_dir",		ctypes.POINTER(ctypes.c_char)),
	("config_dir",		ctypes.POINTER(ctypes.c_char)),] )

mono_set_assemblies_path = _rpythonic_function_(		"mono_set_assemblies_path", ctypes.c_void_p, [
