...
VC_FAILURE = 1
VC_NO_CB_FUNC = 2
VC_NO_CB_CONN_FUNC = 3
VC_NO_CB_TERM_FUNC = 4
VC_NO_CB_USER_AUTH = 5
VRS_CONN_TERM_RESERVED = 0
VRS_CONN_TERM_HOST_UNKNOWN = 1
VRS_CONN_TERM_HOST_DOWN = 2
VRS_CONN_TERM_SERVER_DOWN = 3
VRS_CONN_TERM_AUTH_FAILED = 4
VRS_CONN_TERM_TIMEOUT = 5
VRS_CONN_TERM_ERROR = 6
VRS_CONN_TERM_CLIENT = 7
VRS_CONN_TERM_SERVER = 8
PERM_NODE_READ = 1
PERM_NODE_WRITE = 2
UA_METHOD_RESERVED = 0
UA_METHOD_NONE = 1
UA_METHOD_PASSWORD = 2
UA_METHOD_HOSTBASED = 3
UA_METHOD_CERTIFICATE = 4
RESERVED_USER_ID = 0
RESERVED_AVATAR_ID = 0
MAX_USERNAME_LENGTH = 64
MAX_DATA_LENGTH = 128
STRING8_MAX_SIZE = 255
STRING16_MAX_SIZE = 65536
ROOT_NODE_ID = 0
AVATAR_PARENT_NODE_ID = 1
USERS_PARENT_NODE_ID = 2
SCENE_PARENT_NODE_ID = 3
SUPER_USER_UID = 100
FIRST_SYS_NODE_ID = 100
LAST_SYS_NODE_ID = 999
FIRST_USER_NODE_ID = 1000
LAST_USER_NODE_ID = 65535
FIRST_COMMON_NODE_ID = 65536
RESERVED_NODE_ID = 4294967295
RESERVED_TAGGROUP_ID = 65535
DEFAULT_PRIORITY = 128
MIN_UA_METHOD_COUNT = 0
MAX_UA_METHOD_COUNT = 1
PRINT_NONE = 0
PRINT_INFO = 1
PRINT_ERROR = 2
PRINT_WARNING = 3
...
TAG_TYPE_REAL64 = 10
TAG_TYPE_STRING8 = 11
TAG_TYPE_VEC2_INT32 = 12
TAG_TYPE_VEC3_INT32 = 13
TAG_TYPE_VEC4_INT32 = 14
TAG_TYPE_VEC2_REAL32 = 15
TAG_TYPE_VEC3_REAL32 = 16
TAG_TYPE_VEC4_REAL32 = 17
TAG_TYPE_VEC2_REAL64 = 18
TAG_TYPE_VEC3_REAL64 = 19
TAG_TYPE_VEC4_REAL64 = 20
## enums ##
...
class string8(_rpythonic_struct_): _array_wrapper_ = True
## union and structures ##
__freeze_rpythonic_struct( string8, [
	( "length", ctypes.c_ubyte ),
	( "C_str", ( ctypes.c_ubyte * 598 ) ),
])

## wrapper functions ##
register_receive_user_authenticate = _rpythonic_function_(		"register_receive_user_authenticate", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_fps = _rpythonic_function_(		"verse_send_fps", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("fps",		ctypes.c_float),] )

verse_send_node_create = _rpythonic_function_(		"verse_send_node_create", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),] )

register_receive_node_create = _rpythonic_function_(		"register_receive_node_create", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

register_receive_tag_set_uint32 = _rpythonic_function_(		"register_receive_tag_set_uint32", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_tag_set_int64 = _rpythonic_function_(		"verse_send_tag_set_int64", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),
	("tag_id",		ctypes.c_ushort),
	("value",		ctypes.c_int64),] )

verse_send_tag_set_string8 = _rpythonic_function_(		"verse_send_tag_set_string8", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),
...
register_receive_tag_set_string8 = _rpythonic_function_(		"register_receive_tag_set_string8", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_tag_set_vec3_real32 = _rpythonic_function_(		"verse_send_tag_set_vec3_real32", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),
...
verse_send_node_destroy = _rpythonic_function_(		"verse_send_node_destroy", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),] )

register_receive_node_destroy = _rpythonic_function_(		"register_receive_node_destroy", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_node_subscribe = _rpythonic_function_(		"verse_send_node_subscribe", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("level",		ctypes.c_uint),] )

verse_send_tag_set_real64 = _rpythonic_function_(		"verse_send_tag_set_real64", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),
...
register_receive_tag_set_real64 = _rpythonic_function_(		"register_receive_tag_set_real64", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_tag_destroy = _rpythonic_function_(		"verse_send_tag_destroy", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),
...
register_receive_tag_destroy = _rpythonic_function_(		"register_receive_tag_destroy", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_tag_set_int8 = _rpythonic_function_(		"verse_send_tag_set_int8", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),
...
register_receive_tag_set_int64 = _rpythonic_function_(		"register_receive_tag_set_int64", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_tag_set_uint64 = _rpythonic_function_(		"verse_send_tag_set_uint64", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),
...
register_receive_tag_set_uint64 = _rpythonic_function_(		"register_receive_tag_set_uint64", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_tag_set_real32 = _rpythonic_function_(		"verse_send_tag_set_real32", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),
...
register_receive_tag_set_real32 = _rpythonic_function_(		"register_receive_tag_set_real32", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

register_receive_tag_set_vec3_real32 = _rpythonic_function_(		"register_receive_tag_set_vec3_real32", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

register_receive_tag_set_int8 = _rpythonic_function_(		"register_receive_tag_set_int8", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_tag_set_uint8 = _rpythonic_function_(		"verse_send_tag_set_uint8", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),
...
register_receive_tag_set_uint8 = _rpythonic_function_(		"register_receive_tag_set_uint8", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_tag_set_int16 = _rpythonic_function_(		"verse_send_tag_set_int16", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),
...
register_receive_tag_set_int16 = _rpythonic_function_(		"register_receive_tag_set_int16", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_tag_set_int32 = _rpythonic_function_(		"verse_send_tag_set_int32", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),
...
register_receive_tag_set_int32 = _rpythonic_function_(		"register_receive_tag_set_int32", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_tag_set_uint32 = _rpythonic_function_(		"verse_send_tag_set_uint32", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),
...
verse_send_node_prio = _rpythonic_function_(		"verse_send_node_prio", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("node_prio",		ctypes.c_ubyte),] )

verse_send_taggroup_create = _rpythonic_function_(		"verse_send_taggroup_create", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("name",		ctypes.POINTER(ctypes.c_char)),] )

register_receive_taggroup_create = _rpythonic_function_(		"register_receive_taggroup_create", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_tag_set_uint16 = _rpythonic_function_(		"verse_send_tag_set_uint16", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),
...
register_receive_tag_set_uint16 = _rpythonic_function_(		"register_receive_tag_set_uint16", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_node_unsubscribe = _rpythonic_function_(		"verse_send_node_unsubscribe", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),] )

verse_send_node_link = _rpythonic_function_(		"verse_send_node_link", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("parent_node_id",		ctypes.c_uint),
	("child_node_id",		ctypes.c_uint),] )

register_receive_node_link = _rpythonic_function_(		"register_receive_node_link", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_taggroup_destroy = _rpythonic_function_(		"verse_send_taggroup_destroy", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),] )

register_receive_taggroup_destroy = _rpythonic_function_(		"register_receive_taggroup_destroy", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_taggroup_subscribe = _rpythonic_function_(		"verse_send_taggroup_subscribe", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),] )

verse_send_taggroup_unsubscribe = _rpythonic_function_(		"verse_send_taggroup_unsubscribe", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),] )

verse_send_tag_create = _rpythonic_function_(		"verse_send_tag_create", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("prio",		ctypes.c_ubyte),
	("node_id",		ctypes.c_uint),
	("taggroup_id",		ctypes.c_ushort),
...
register_receive_tag_create = _rpythonic_function_(		"register_receive_tag_create", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_set_debug_level = _rpythonic_function_(		"verse_set_debug_level", ctypes.c_int, [
	("debug_level",		ctypes.c_ubyte),] )

verse_strerror = _rpythonic_function_(		"verse_strerror", ctypes.POINTER(ctypes.c_char), [
	("error_num",		ctypes.c_uint),] )

register_receive_connect_accept = _rpythonic_function_(		"register_receive_connect_accept", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

func = _rpythonic_function_(		"func", ctypes.c_void_p, [
	("session_id",		ctypes.c_ubyte),
	("user_id",		ctypes.c_ushort),
	("avatar_id",		ctypes.c_uint),] )

register_receive_connect_terminate = _rpythonic_function_(		"register_receive_connect_terminate", ctypes.c_void_p, [
	("func",		ctypes.c_void_p),] )

verse_send_connect_request = _rpythonic_function_(		"verse_send_connect_request", ctypes.c_int, [
	("hostname",		ctypes.POINTER(ctypes.c_char)),
	("service",		ctypes.POINTER(ctypes.c_char)),
	("flags",		ctypes.c_ushort),
	("session_id",		ctypes.POINTER(ctypes.c_ubyte)),] )

verse_send_user_authenticate = _rpythonic_function_(		"verse_send_user_authenticate", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),
	("username",		ctypes.POINTER(ctypes.c_char)),
	("auth_type",		ctypes.c_ubyte),
	("data",		ctypes.POINTER(ctypes.c_char)),] )

verse_send_connect_terminate = _rpythonic_function_(		"verse_send_connect_terminate", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),] )

verse_callback_update = _rpythonic_function_(		"verse_callback_update", ctypes.c_int, [
	("session_id",		ctypes.c_ubyte),] )
...
_rpythonic_strip_prefixes_(['ve_'])